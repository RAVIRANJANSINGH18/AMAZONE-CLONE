...
(function() {
    var n = this && this.__extends || function() {
        ...
        l = [],
        f, m = function(a) {
            self.$TM && "function" === typeof self.$TM.error ? self.$TM.error(a) : (l.push(a), f || (f = setInterval(function() {
        ...
        e = function(a, b) {
            for (var c = 0; c < b.length; c++) {
                var d =
                    b[c];
                if ("object" === typeof a && null !== a && void 0 !== a[d]) a = a[d];
                else return
            }
            return a
        },
        ...
        r = function(a, b) {
            if ("mshop" === b) {
                ...
                if (!b || "string" !== typeof b) return !1;
                a = e(a, ["osName"]);
                if (!a || "string" !== typeof a || !g(b, a)) return !1
            }
            return !0
        },
        t = function(a) {
        ...
        u = function() {
            ...
            a.prototype.compareVersion = function(a) {
                var b = this.getAppVersion(),
                    d = this.getOsName();
                a: {
                    if (!g(b, d) || !g(a, d)) throw b = new k("InvalidAppVersionComparison", "Error: version [".concat(b, "] or [").concat(a, "] for OS [").concat(d,
                        "] is invalid")), m(b), b;b = b.split(".").map(Number).slice(0, 3);a = a.split(".").map(Number).slice(0, 3);
                    for (d = 0; 3 > d; d++) {
                        var e = b[d] - a[d];
                        if (0 !== e) {
                            b = e;
        ...
        y = function() {
            ...
            a.prototype.getFeatureProperties = function(a, c) {
                var b, e;
                return (a = null ===
                    (e = null === (b = this.namespacesData) || void 0 === b ? void 0 : b[a]) || void 0 === e ? void 0 : e[c]) ? new w(a) : void 0
            };
            return a
        }();
    self.$RuntimeConfig = new y(function() {
        if (self.getServiceWorkerGlobalClientConfigData && "function" === typeof self.getServiceWorkerGlobalClientConfigData) {
            var a = self.getServiceWorkerGlobalClientConfigData(),
                b;
            if (b = !!a)
...
(function() {
    var a = this && this.__assign || function() {
            a = Object.assign || function(e) {
                for (var b, c = 1, a = arguments.length; c < a; c++) {
                    b = arguments[c];
                    for (var d in b) Object.prototype.hasOwnProperty.call(b, d) && (e[d] = b[d])
                }
                return e
            };
    ...
    (function() {
        if (!g) throw Error("Could not initialize CSA config");
...
(function() {
    ...
    (function(a) {
        ...
        function h(a, e, c) {
            var g = !0;
            e = f(e);
            c && c.buffered && (g = (y[a] || []).every(function(a) {
                return !1 !== e(a)
            }));
            return g ? (A[a] || (A[a] = []), A[a].push(e), function() {
                var c = A[a];
                c && c.splice(c.indexOf(e), 1)
            }) : E
        }

        function k(a, e) {
            e = f(e);
            return a in G ? (e(G[a]), E) : h(a, function(a) {
                e(a);
                return !1
            })
        }
        ...
        function r(a, e) {
            p("Errors")("logError", a);
            if (v.DEBUG) throw e || a;
        }

        function l() {
            return Math.abs(4294967295 * Math.random() |
                0).toString(36)
        }
        ...
        function q(a) {
            var e = g[a[0]],
                c = a[1],
                b = c[0];
            if (!e || !e[b]) return r("Undefined function: " + e + "/" + b);
            D = a[3];
            g[a[2]] = e[b].apply(e, c.slice(1)) || {};
            D = 0
        }
        ...
        b.once = k;
        b.blank = E;
        b.emit = function(a, e, c) {
            for (var g = A[a] || [], b = 0; b < g.length;) !1 === g[b](e) ? g.splice(b, 1) : b++;
            G[a] = e || {};
            c && c.buffered && (y[a] || (y[a] = []), 100 <= y[a].length && y[a].shift(), y[a].push(e || {}))
        };
        b.UUID = function() {
            return [l(), l(), l(), l()].join("-")
        };
        b.time = function(a) {
            var e = D ? new Date(D.time) :
                new Date;
            return "ISO" === a ? e.toISOString() : e.getTime()
        };
        b.error = r;
        b.warn = function(a, e) {
            p("Errors")("logWarn", a);
        ...
        b.exec = f;
        b.timeout = m;
        b.interval = function(e, c) {
            return a.setInterval(f(e), c)
        };
        b.global = a;
        a.csa._s.push = function(a) {
            a[0] in g && (!n.length || z) ? (q(a), n.length && e !== x && u()) : n.splice(c++, 0, a)
        };
        u();
        m(function() {
    ...
    csa.plugin(function(a) {
        var b = a.exec,
            ...
            h = a.on;
        a.raf = function(a) {
            if (d.requestAnimationFrame) return d.requestAnimationFrame(b(a))
        };
        a.on = function(b, d, l, f) {
            if (b && "function" === typeof b.addEventListener) {
                var m = a.exec(l);
                b.addEventListener(d, m, f);
                return function() {
                    b.removeEventListener(d, m, f)
                }
            }
            return "string" === typeof b ? h(b, d, l, f) : a.blank
        }
    });
    csa.plugin(function(a) {
        function b(b, d) {
        ...
        a.deleteStored = l(function(a, b) {
            ...
            if ("function" === typeof a)
                for (var f in b) b.hasOwnProperty(f) && a(f, b[f]) && delete b[f];
            else delete b[a]
        })
    });
    csa.plugin(function(a) {
        a.types = {
            ovl: function(a) {
                var b = [];
                if (a)
                    for (var h in a) a.hasOwnProperty(h) && b.push(a[h]);
                return b
            }
        }
    });
    csa.plugin(function(a) {
        ...
        function d(b) {
            function d(d) {
                ...
                d.logLevel && (f.logLevel = "" + d.logLevel);
                u.forEach(function(a) {
                    d[a] && (f.metadata[a] = d[a])
                });
                if ("INFO" === d.logLevel) return f;
                Object.keys(q).forEach(function(a) {
                    if ("number" === typeof d[q[a]] || "string" === typeof d[q[a]]) f[a] = "" + d[q[a]]
                });
                return f
            }
            var k, f, m = a("Events", {
    ...
    csa.plugin(function(a) {
        ...
        function d(b, d, c) {
            v(d, function(g) {
                var e = "string" !== typeof d[g] && "version" !== g ? a.error("Attribute is not of type string: " + g) : !0 === c || 1 === c ? !0 : "id" === g || -1 !== (c || []).indexOf(g);
                e && (b[g] = d[g])
            })
        }
            ...
            v(b, function(b) {
                ...
                if (b.schemaId) {
                    var e = {},
                        g = {};
                    e.id = b.id;
                    e.producerId = b.producerId || c.producerId;
                    e.schemaId = b.schemaId;
                    e.version = b.version++;
                    e.attributes = g;
                    k(e, c);
                    d(g, b, 1);
        ...
        function k(b, d) {
            var c = b.timestamp;
            "number" === typeof c && (c = (new Date(c)).toISOString());
            c = c || a.time("ISO");
            b.timestamp = c;
        ...
        function l(d) {
            var f = {};
            this.log = function(c, g) {
                var e = {},
                    h = (g || {}).ent;
                if (!c) return a.error("The event cannot be undefined");
                if ("string" !== typeof c.schemaId) return a.error("A valid schema id is required for the event");
                k(c, d);
                b(e, p, h);
                b(e, f, h);
                b(e, c.entities || {}, h);
    ...
    csa.plugin(function(a) {
        ...
        function k(a, d, g, h) {
            var e = c && c[f[a] || "log"];
            m && m.TRACE && b(e) && e("[CSA:ServiceWorker] " + d, g, h);
            "le" === a ? x("logError", d + " " + g + " " + h) : "lw" === a && x("logWarn", d + " " + g + " " + h)
        }

        function r(a,
            d, c) {
            var e = a.clientId || (a.source || {}).id,
                f;
            k("i", "Got fetch-check message from clientId: ", e);
            e && n.clients && (f = n.clients.get(e).then(function(a) {
                a && b(a.postMessage) && (k("i", "Sending fetch-check success message back to clientId: ", e), a.postMessage({
                    client: e,
                    message: {
                        _messageType: c,
                        success: !0
        ...
        function l(a) {
            var e = a.body && (h(a.body) ? a.body : JSON.stringify(a.body)),
                c = a.url,
                f = a.headers || v || {
                    "Content-Type": a.type || p || "application/json; charset\x3dUTF-8"
                };
            k("i", "Got fetch message: ", c, e);
            if (e &&
                c && b(n.fetch)) {
                if (u) try {
                    var g = JSON.parse(e);
                    g.events && g.events.length && b(g.events.forEach) && g.events.forEach(function(a) {
                        d(a) && d(a.data) && (a = a.data, "entities" in a && d(a.entities) ? a.entities.transport = {
                            type: "ServiceWorker"
                        } : "attributes" in a && d(a.attributes) && (a.attributes.transportType = "ServiceWorker"))
                    });
                    e = JSON.stringify(g)
                } catch (B) {
                ...
                var l = n.fetch(c, a).catch(function(a) {
                    k("e", "Failed to send fetch request: ", a)
                });
                k("i", "Sending fetch message: ", c, a)
            }
            return l
        }
        var f = {
        ...
        g = a.on;
        var x = a("Errors");
        n && (a.isSW = !0, g(n, "message",
            function(a) {
                if (a) {
                    var e = a.data || {},
                        c = e._messageType;
                    if ("fetch" === c) var d = l(e);
                    else if ("fetch-check" === c) d = r(a, e, c);
                    else if ("config" === c) {
                        c = e.config;
                        e = e.replace;
                        if (c) {
                            if (e) m = c;
                                ...
                                for (var f in c) c.hasOwnProperty(f) && (m[f] = c[f]);
                            k("i", "Config updated: ", m)
                        }
                        d = void 0
                    } else c && k("le", "Unknown event type:", c);
                    d && b(a.waitUntil) && a.waitUntil(d)
                }
            }), g(n, "install", function(a) {
            a && b(a.waitUntil) && b(n.skipWaiting) && a.waitUntil(n.skipWaiting)
        }), g(n, "activate", function(a) {
            a && b(a.waitUntil) && n.clients && b(n.clients.claim) &&
                a.waitUntil(n.clients.claim())
    ...
    csa.plugin(function(a) {
        ...
        function r(b) {
            if (864E5 < a.time() - +new Date(b.timestamp)) return a.warn("Event is too old: " + b);
            x < w && (b.messageId in c || (c[b.messageId] = b, x++), "function" === typeof b.__merge && b.__merge(c[b.messageId]), !H && q && (b = C, C = Math.min(b * K, L), H = y(l, b)))
        }
        ...
        function m(a, b, c) {
            var d = z.navigator || {},
                e = z.cordova || {};
            if (!d.sendBeacon || !a.post) return 0;
            a.preflight && e && "ios" === e.platformId && !D && ((new Image).src = a.preflight().url, D = 1);
            a = a.post(b);
            if (!a.type && d.sendBeacon(a.url, a.body)) return c(), 1
        }
        ...
        function u(b, c, d) {
            ...
            var f = b.url,
                ...
                l = 0;
            k.onload = function() {
                299 > k.status ? d() : a.config["Transport.XHRRetries"] && 3 > l && (l++, y(function() {
                    e(f, g, h)
                }, l * t))
            };
            e(f, g, h);
        ...
        var q = 0,
            w = a.config["Transport.BufferSize"] || 2E3,
            t = a.config["Transport.RetryDelay"] || 1500,
            p = a.config["Transport.ServiceWorker.JSCodePath"],
            ...
            E = a.once,
            F = z.Object.keys,
            I = a.config["Transport.FlushInterval"] || 5E3,
            C = I,
            K = a.config["Transport.FlushInterval.BackoffFactor"] || 1,
            L = a.config["Transport.FlushInterval.BackoffLimit"] || 3E4,
            H = 0,
            J = a.blank;
        F && (g ? b() : v && h(), E("$afterload", function() {
            q = 1;
            k(r);
    ...
    csa.plugin(function(a) {
        ...
        a("Transport")("register", {
            ...
            chunks: function(a) {
                for (var b = []; 500 < a.length;) b.push(a.splice(0, 500));
                b.push(a);
                return b
            }
        })
    ...
    csa.plugin(function(a) {
        function b(b) {
            ...
            var l = b.producerId,
                ...
                q, w, t = {},
                p = -1;
            if (!l && !f) return a.error("Either a producer id or custom logger must be defined");
            this.recordMetric = function(a, d) {
                var f = b.logOptions || {
                    ent: {
                        page: ["pageType", "subPageType", "requestId"]
                    }
            ...
            this.recordCounter = function(d, f) {
                var g = b.logOptions || {
                    ent: {
                        page: ["pageType", "subPageType", "requestId"]
                    }
                };
                if ("string" != typeof d || "number" != typeof f || !isFinite(f)) return a.error("Invalid type given for counter name or counter value: " + d + "/" + f);
                p !== h && (k(), p = h);
                d in t || (t[d] = {});
                var c = t[d];
                "f" in c || (c.f = f);
                ...
                m("log", {
                    ...
                    __merge: function(a) {
                        d in a.c || (a.c[d] = {});
                        c.fs || (c.fs = 1, a.c[d].f = c.f);
                        1 < c.c && (a.c[d].s = c.s, a.c[d].l = c.l, a.c[d].c = c.c)
                    }
                }, g)
            }
        }
        var d = a.config,
            h = 0;
        d["KillSwitch.Metrics"] || ((new b({
            producerId: "csa"
        })).recordMetric("baselineMetricEvent", 1), a.on("$beforePageTransition", function() {
            h++
        }), a.register("Metrics", {
            instance: function(a) {
                return new b(a || {})
    ...
    csa.plugin(function(a) {
        ...
        function d(b) {
            ...
            if (!d && !f) return a.error("Either a producer id or custom logger must be defined");
            this.mark = function(d, f) {
        ...
        var h = a.config,
            k = (a.global.performance || {}).timing,
            r = (k || {}).navigationStart || a.time(),
            l;
        k && (b(), a.on("$beforePageTransition", b), a.register("Timers", {
            instance: function(a) {
                return new d(a || {})
            }
        }))
...
(function(I) {
    var J = this && this.__spreadArray || function(d, b, a) {
        ...
        K = function(d, b, a) {
            ...
            A.isDebugVerbose && console.debug.apply(console, J(["%cServiceWorkerMetric%c%c".concat(d, "%c%c").concat(b, "%c ").concat(a), "background-color: #3333ff; color: #FFFFFF; padding: 5px", "color: auto",
    ...
    (function(d) {
        d.isNonCustomerImpactingError = function(b) {
            var a;
            if (a = b instanceof Error || b instanceof ErrorEvent) b = b.message, a = m.matchesPattern(b, z.USER_DENIED_PERMISSION) || m.matchesPattern(b, z.SERVICE_WORKER_FETCH_API_FAILED) || m.matchesPattern(b,
                z.NETWORK_ERROR);
            return a
        }
    })(B || (B = {}));
    var O = this && this.__extends || function() {
        ...
        E = function(d) {
            ...
            b.prototype._onMessageReceived = function(a) {
                if (a.origin === this._swGlobal.location.origin) {
                    var b = a.source;
                    b instanceof WindowClient && (a = a.data, m.isObject(a) && "retail_service_worker_messaging" ===
                        a.feature && a.command === this._messageCommand && this._clientMessageHandler(a, b))
                }
            };
            return b
        }(n),
        ...
        Q = function(d) {
            ...
            b.prototype.getForesterURLForClient = function(a) {
                return (a = this.getClientDataForClient(a)) ?
                    a.foresterURL : void 0
            };
            ...
            b.prototype._onClientLoaded = function(a, b) {
                if (!a.data || !m.isNonEmptyString(a.data.rid)) throw r.create("InvalidPostbackDataOnPageLoad", "Incorrect postback data received on page load", void 0, "ERROR");
                this.print("processMessage", "Page loaded message received from client ".concat(b.id), a);
                this._saveClientData(a.data,
                    b.id)
            };
        ...
        S = function(d) {
                        ...
                        return u(this, function(f) {
                            switch (f.label) {
                                ...
                                case 2:
                                    ...
                                    f.label = 3;
                                case 3:
                                    return f.trys.push([3, 5, , 6]), [4, this._getClient(e)];
                                case 4:
                                ...
                                case 5:
                                    return d = f.sent(), this.countInternal(v.format(b._CLIENT_UNAVAILABLE_COUNTER)),
                                        this.print("counter", d.message), [3, 6];
                                case 6:
                                    return [2]
                            }
                        })
                    ...
                    return t(e, void 0, void 0, function() {
                        ...
                        return u(this, function(h) {
                            switch (h.label) {
                                ...
                                case 3:
                                    return d = h.sent(), this.countInternal(v.format(b._CLIENT_UNAVAILABLE_COUNTER),
                                        1), this.print("tag", d.message), [3, 4];
                                case 4:
                                    return [2]
                            }
                        })
            ...
            b.prototype._flushMetricForClient =
                function(a) {
                    var b = this;
                    l(function() {
            ...
            b.prototype._drainBufferedTags = function(a) {
                for (var c = this, e = [], h = a.id, d = function(d) {
                        ...
                        if (h !== g.clientID) return e.push(g), "continue";
                        l(function() {
                            return t(c, void 0, void 0, function() {
                                return u(this, function(c) {
                                    this._postMessage(a, {
            ...
            b.prototype._drainBufferedWeblabTriggers = function(a) {
                for (var c = this, e = [], h = a.id, d = function(d) {
                        ...
                        this, k = 0; k < this._bufferedWeblabTriggers.length; k++) d(k);
            ...
            b.prototype._drainBufferedInternalCounter = function(a) {
                for (var c = this, e = function(e) {
                    ...
                    }, h = this, d = 0; d < this._bufferedInternalCounters.length; d++) e(d);
                    ...
                    function() {
                        ...
                        return u(this, function(c) {
                            switch (c.label) {
                                ...
                                case 4:
                                    return d = c.sent(), this.print("Looking for last available client", d.message), [3, 5];
                                case 5:
                                    return b--, [3, 1];
                                case 6:
                                    return [2]
            ...
            b._MESSAGING_COMMAND_WEBLAB_TRIGGER =
                "log_weblab_trigger";
    ...
    var X = function() {
            ...
            d.prototype._resolveDeviceType = function() {
                if (!this._swGlobal.$RuntimeConfig) return y.Desktop;
                var b =
                    this._swGlobal.$RuntimeConfig.getDeviceProperties();
        ...
        ca = function(d) {
            ...
            b.prototype._getErrorLocationFromStackFrames = function(a) {
                if ((a = (1 < a.length ? a[1] : "").match(aa)) && 4 === a.length) return {
                    fileName: a[1],
                    lineNumber: a[2],
                    colNumber: a[3]
                }
        ...
        ea = function(d) {
            ...
            b.prototype.record = function(a, b, e, d, g) {
                this._isNotError(a) || this._hasErrorCountThresholdBreached() ? this.print("record", "ERROR NOT LOGGED. Received error is not valid or error threshold is breached.") : (this._errorCount++, !b && B.isNonCustomerImpactingError(a) && (b = "ERROR"), this._recordErrorForClient(a,
                    b, e, d, g), this._logThresholdReached())
            };
            b.prototype._addGlobalErrorListener = function() {
                ...
                this._swGlobal.addEventListener("unhandledrejection", function(b) {
                    l(function() {
                        b.reason instanceof Error && (a.print("globalErrorListener", "promise rejection error captured", b), a.record(b.reason))
                    })
                })
            };
            ...
            b.prototype._recordError = function(a, b, e, d, g) {
                ...
                this.print("recordError", "Generated error record",
                    a);
        ...
        la = function(d) {
            ...
            b.prototype.triggerWeblab = function(a) {
                return F(this, void 0, void 0, function() {
                    ...
                    return G(this, function(c) {
                        switch (c.label) {
                            case 0:
                                b = this._getWeblabTriggerOptions(), c.label = 1;
                            case 1:
                                return c.trys.push([1, 3, , 4]), [4, fetch(a, b)];
                            case 2:
                                return c.sent(), this.print("triggerWeblab", "Weblab triggered successfully"), [3, 4];
                            case 3:
                                throw e = c.sent(), this.print("triggerWeblab", "Weblab trigger failed", e), e;
                            case 4:
                                return [2]
                        }
                    })
            ...
            b.prototype._getRequestOptions =
                function(a) {
                    return {
                        method: "POST",
                        mode: "no-cors",
        ...
        na = function(d) {
            ...
            b.prototype.getSyntheticRequestID =
                function() {
        ...
        oa = this && this.__extends || function() {
            ...
            return function(b, a) {
                ...
                d(b, a);
                b.prototype = null === a ?
                    Object.create(a) : (c.prototype = a.prototype, new c)
            }
        }(),
            ...
            b.prototype._retrieveSessionIDFromCookieStore = function() {
                return pa(this, void 0, void 0, function() {
                    ...
                    return qa(this, function(c) {
                        switch (c.label) {
                            case 0:
                                if (!("cookieStore" in this._swGlobal && "get" in this._swGlobal.cookieStore)) return [2];
                                c.label = 1;
                            case 1:
                            ...
                            case 3:
                                return b = c.sent(), this.print("retrieveSessionIDFromCookieStore", "Failed to retrieve cookie from cookie store",
                                    b), [3, 4];
                            case 4:
                                return [2]
                        }
        ...
        va = function(d) {
            ...
            b.prototype.trigger = function(a, c) {
                ...
                !a.length || this._callCount >= b.MAX_CALLS_COUNT || (this._callCount++, this._recordTrigger(a, c), this._logThresholdReached())
            };
            b.prototype._logThresholdReached = function() {
            ...
            b.prototype._recordTrigger = function(a, c) {
                ...
                a.forEach(function(a) {
                    ...
                    h.length > b.MAX_FORESTER_URL_LENGTH && (d._flush(h), h = g = "")
                });
                h && this._flush(h)
            };
            b.prototype._flush = function(a) {
                try {
                    this._foresterRequest.triggerWeblab(a), this._swGlobal.$TM.count(v.format("".concat(b.FORESTER_CLIENT_MODULE,
                        ":SUCCESS")))
                } catch (c) {
        ...
        za = function(d) {
            ...
            b.prototype.triggerWeblab = function(a, b) {
                var c = this;
                if (!m.isNonEmptyString(b)) throw r.create("ClientIDMissing", "Client id missing for triggering weblab via page");
                a.forEach(function(a) {
                    c._clientPostback.weblabTrigger(a.name, a.treatment, b)
                })
            };
            b.prototype.triggerWeblabFromWorker =
                function(a, b) {
                    if (!m.isNonEmptyString(b)) throw r.create("RequestIDMissing", "Request id missing for triggering weblab via page");
        ...
        Ba = function(d) {
            ...
            b.prototype.count = function(a, b, d) {
                var c = this;
                if (!m.isAsciiString(a)) throw r.create("NonASCIICharacters", "Counter name contains non-ASCII characters ".concat(a));
                l(function() {
            ...
            b.prototype.tag = function(a, b) {
                var c = this;
                if (!b || !m.isNonEmptyString(b.clientID)) throw r.create("ClientIDMissing", "Client id missing for tag ".concat(a));
                l(function() {
        ...
        H = !1,
        Ca = function(d) {
            if (!d || "object" !== typeof d) throw r.create("InvalidForesterConfiguration");
            ["channel", "foresterEndpoint", "marketplaceID", "siteName", "attribution"].forEach(function(b) {
                b =
                    d[b];
                if ("string" !== typeof b || !b.length) throw r.create("InvalidForesterConfiguration");
            })
        };
    I.init = function(d) {
        if (H) throw r.create("DuplicateLibraryInitialization");
        Ca(d.foresterConfig);
        Z();
...
(function(c) {
    var a = this && this.__assign || function() {
        ...
        f = a({
            ...
            foresterEndpoint: "fls-na.amazon.com"
        }, {
            channel: "jserr-rw",
...
(function() {
    (function(zc) {
        function Ac(f, b, a) {
            if (M.isDebugVerbose) {
                ...
                a.value = function() {
                    ...
                    G.print(g, b, "".concat("\x3c\x3c\x3c", " %o"), a);
                    G.rightShift();
                    a = e.apply(this, a);
                    G.leftShift();
                    G.print(g, b, "".concat("\x3e\x3e\x3e", " %o"), a);
                    return a
                };
                return a
            }
        ...
        function k() {
            ...
            switch (f.length) {
                case 3:
                    if ("number" !== typeof f[2]) return Ac(f[0], f[1], f[2]);
                default:
        ...
        (function(f) {
            ...
            f.getCountryCode = function(b) {
                b = b.$RuntimeConfig && "function" === typeof b.$RuntimeConfig.getMarketplaceProperties ? b.$RuntimeConfig.getMarketplaceProperties() : void 0;
                if (b && "function" === typeof b.getCountryCode) return b.getCountryCode()
            };
            f.isClientEnabled = function(b) {
                var a;
                b = b.$RuntimeConfig && "function" === typeof b.$RuntimeConfig.getFeatureProperties ?
                    null === (a = b.$RuntimeConfig.getFeatureProperties("in-latency", "".concat("lightsaber", "-").concat("web"))) || void 0 === a ? void 0 : a.getData() : void 0;
                return null === b || void 0 === b ? void 0 : b.clientEnabled
            }
        })(R || (R = {}));
        var Bc = this && this.__read || function(f, b) {
                ...
                try {
                    for (;
                        (void 0 === b || 0 < b--) && !(e = f.next()).done;) c.push(e.value)
                } catch (h) {
                    var g = {
                        error: h
                    }
            ...
            v;
        (function(f) {
            var b = (b = "AmazonLightsaberServiceWorkerClientLib-1.0.1313.0".match(/^([^\-]+)\-((\w+\.\w+)(?:\.\w+)*)$/)) && b[1] && b[2] && b[3] ? b.slice(1) : ["unknown", "unknown", "unknown"];
            var a = Bc(b, 3);
            b = a[0];
            var e = a[1];
            a = a[2];
        ...
        var Cc = this && this.__awaiter || function(f, b, a, e) {
                function c(c) {
            ...
            Ec = this && this.__read || function(f, b) {
                var a = "function" === typeof Symbol && f[Symbol.iterator];
                if (!a) return f;
                f = a.call(f);
                var e, c = [];
            ...
            Fc = this && this.__spreadArray || function(f, b, a) {
                if (a || 2 === arguments.length)
                            ...
                            switch (d.label) {
                                case 0:
                                    ...
                                    a.replace(e, function(a) {
                                        ...
                                        e = c.call.apply(c, Fc([void 0, a], Ec(e), !1));
                                        b.push(e);
                                        return ""
                                    });
                                    return [4, Promise.all(b)];
                                case 1:
                                    return h = d.sent(), [2, a.replace(e, function() {
                                        return h.shift()
                                    })]
                            }
                        })
        ...
        var Gc = this && this.__read || function(f, b) {
            ...
            Hc = this && this.__spreadArray || function(f, b, a) {
                if (a || 2 ===
                    arguments.length)
                    for (var e = 0, c = b.length, g; e < c; e++) !g && e in b || (g || (g = Array.prototype.slice.call(b, 0, e)), g[e] = b[e]);
                return f.concat(g || Array.prototype.slice.call(b))
        ...
        (function(f) {
            var b = 0,
                a = function() {
                    var a = new Date,
                        c = S.pad(a.getHours(), 2, "0"),
                        b = S.pad(a.getMinutes(), 2, "0"),
                        h = S.pad(a.getSeconds(), 2, "0");
                    a = S.pad(a.getMilliseconds(), 3, "0");
                    return "".concat(c, ":").concat(b, ":").concat(h, ".").concat(a)
                };
            f.print = function(e, c, g) {
                for (var h = [], d = 3; d < arguments.length; d++) h[d - 3] = arguments[d];
                M.isDebugVerbose &&
                    (d = "  ".repeat(b || 0), console.debug.apply(console, Hc(["%c".concat(a(), "%c%c").concat(v.NAMESPACE, "%c  ").concat(d, "%c").concat(e, "%c%c").concat(c, "%c ").concat(g), "background-color: #e1eaeb; color: #fff; padding: 5px 8px", "color: auto; font-weight: normal", "background-color: #3498db; color: #fff; padding: 5px 8px", "color: auto; font-weight: normal", "background-color: #f39c12; color: #fff; padding: 5px 8px", "color: auto; font-weight: normal", "background-color: #e1eaeb; padding: 5px 8px", "color: auto; font-weight: normal"],
                        Gc(h), !1)))
            };
        ...
        var Ic = function() {
            ...
            Ca;
        (function(f) {
            var b = R.isMShop() ? "SMA" : "SW";
            f.format = function(a) {
                return "".concat(v.NAMESPACE, ":").concat(b, ":").concat(a).toLowerCase()
            }
        })(Ca || (Ca = {}));
        var Jc = this && this.__extends ||
            function() {
                var f = function(b, a) {
            ...
            Kc = function(f) {
                function b(a,
                    ...
                    c.name = "".concat(v.NAMESPACE, "Error");
                    c.code = a;
                    c.data = e;
                    c.logLevel = h;
                    return c
                ...
                b._getMessage = function(a, b, c, g) {
                    ...
                    g && (c = g.stack ? "".concat(g.stack) : "".concat(g), b = "".concat(b, " Caused by ").concat(c).trim());
        ...
        (function(f) {
            f.create =
                function(b, a, e, c, g) {
                    return new Kc(b.toString(), a, e, c, g)
                };
        ...
        var Sa = this && this.__assign || function() {
                Sa = Object.assign || function(f) {
        ...
        (function(f) {
            ...
            (function(b) {
                ...
                b.structuredCloneAsync = function(b) {
                    return Lc(a, void 0, void 0, function() {
        ...
        var Nc = this && this.__awaiter || function(f, b, a, e) {
                function c(c) {
                    return c instanceof a ? c : new a(function(a) {
                        a(c)
                    })
        ...
        (function(f) {
            ...
            f.validateIsUsable = function(a) {
                ...
                if (a.bodyUsed || a.body.locked) throw r.create("ResponseBodyUnusable");
            };
            ...
            f.matchPatterns = function(a, e) {
                return Nc(b, void 0, void 0, function() {
                    var c;
        ...
        (function(f) {
            f.serialize = function(b, a) {
                ...
                try {
                    ...
                    return G.print("SafeJSON", "encode", "JSON stringify failed, input\x3d".concat(b)),
                        "{}"
                }
            };
            f.deserialize = function(b) {
                try {
                    ...
                    return G.print("SafeJSON", "decode", "JSON parse failed, input\x3d".concat(b)), {}
                }
            }
        })(H || (H = {}));
        var I;
        (function(f) {
            f.parse = function(b, a) {
                try {
                    ...
                    G.print("SafeURL", "parse", "URL parse failed, input\x3d".concat(b))
                }
            };
            f.encode = function(b) {
        ...
        (function(f) {
            ...
            f.decode = function(b) {
                try {
                    ...
                    G.print("SafeURIEncode", "decode", "decodeURIComponent failed, input\x3d".concat(b))
                }
            }
        })(J || (J = {}));
        var Ta;
        ...
        var Pc = this && this.__awaiter || function(f, b, a, e) {
                function c(c) {
                    return c instanceof a ? c : new a(function(a) {
                        a(c)
                    })
            ...
            Qc = this && this.__generator || function(f, b) {
                function a(a) {
                    return function(c) {
                        return e([a, c])
                    }
        ...
        (function(f) {
            ...
            f.drain = function(a, e) {
                return Pc(b, void 0, void 0, function() {
                    var c, b;
                    return Qc(this, function(g) {
                        switch (g.label) {
                            case 0:
                                return c = a.getReader(), [4, c.read()];
                            case 1:
                                b = g.sent(), g.label = 2;
                            case 2:
                                if (b.done) return [3, 4];
                                e(b.value);
                                return [4, c.read()];
                            case 3:
                                return b =
        ...
        var Ua = this && this.__awaiter || function(f, b, a, e) {
                function c(c) {
                    return c instanceof a ? c : new a(function(a) {
                        a(c)
                    })
        ...
        (function(f) {
            ...
            f.wait =
                function(a) {
                    return Ua(b, void 0, void 0, function() {
        ...
        (function(f) {
            ...
            f.isURL = function(b) {
                return "string" === typeof b && !!I.parse(b)
            }
        })(q || (q = {}));
        var A;
        (function(f) {
        ...
        var Rc = this && this.__read || function(f, b) {
                var a = "function" === typeof Symbol && f[Symbol.iterator];
                if (!a) return f;
                f = a.call(f);
                var e, c = [];
            ...
            Sc = this && this.__spreadArray || function(f, b, a) {
                if (a || 2 === arguments.length)
                    for (var e = 0, c = b.length, g; e < c; e++) !g && e in b || (g || (g = Array.prototype.slice.call(b, 0, e)), g[e] = b[e]);
                return f.concat(g || Array.prototype.slice.call(b))
            },
            u = function() {
                ...
                f.prototype.log = function(b, a) {
                    ...
                    G.print.apply(G, Sc([this.constructor.name, b, a], Rc(e), !1))
                };
                f.prototype.logCtor =
                    function(b) {
        ...
        var Tc = this && this.__extends || function() {
                var f = function(b, a) {
                    f = Object.setPrototypeOf || {
                        __proto__: []
                    }
            ...
            U = this && this.__decorate || function(f, b, a, e) {
            ...
            Ob = function(f) {
                ...
                b.prototype._getFeatureFailures = function() {
                    ...
                    this._requireNavigationPreloadSupport && (b = T(T({}, b), {
                ...
                b.prototype._logToPageProxy = function() {
                    ...
                    this._isBasicOK() && this._swGlobal.addEventListener("aui-sw:page-proxy:feature-tags:request", function(b) {
                        b = b.detail.callback;
                        var c = [];
                        c.push("Version:".concat(v.VERSION));
                        c.push("Supported:".concat(a._isFeatureOK() ? "Yes" : "No"));
                        b(Promise.resolve(c.map(function(a) {
                            return Ca.format("Client:".concat(a))
                        })))
                    })
                };
                U([k], b.prototype, "validate", null);
                U([k], b.prototype, "supports", null);
                U([k], b.prototype,
                    "_isBasicOK", null);
                U([k], b.prototype, "_isFeatureOK", null);
                U([k], b.prototype, "_getBasicFailures", null);
                U([k], b.prototype, "_getFeatureFailures", null);
                U([k], b.prototype, "_logToPageProxy", null);
                U([k], b, "isCookieStoreSupported", null);
                return b
            }(u),
            ma;
        (function(f) {
            f.create = function(b) {
                return {
                    timeOriginEpoch: F.getEpoch(),
                    timeOriginPerfNow: F.getPerfNow(),
                    clientId: b || "unknown",
                    errorContext: {
                        BuildVersion: v.FULL_VERSION
                    }
                }
            }
        })(ma || (ma = {}));
        var Uc = this && this.__extends || function() {
            ...
            D = this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
                    g = 3 > c ? b : null === e ? e =
                    Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
            ...
            K = this && this.__awaiter || function(f, b, a, e) {
                function c(c) {
                    return c instanceof a ? c : new a(function(a) {
                        a(c)
                    })
            ...
            Ya = this && this.__read || function(f, b) {
                var a = "function" === typeof Symbol && f[Symbol.iterator];
                if (!a) return f;
                f = a.call(f);
                var e, c = [];
            ...
            Vc = function(f) {
                        ...
                        return K(this, void 0, void 0, function() {
                            ...
                            return E(this, function(g) {
                                switch (g.label) {
                                    ...
                                    case 5:
                                        l = g.sent(),
                                            d = this._plugins.length - 1, g.label = 6;
                                    case 6:
                                        if (!(0 <= d)) return [3, 9];
                                        f = this._plugins[d];
                ...
                b.prototype.write = function(a, b, c, g) {
                    return K(this, void 0, void 0, function() {
                        ...
                        return E(this, function(h) {
                            switch (h.label) {
                                case 0:
                                    e = this._toInternalRequest(b), d = this._cloneResponse(a, c), f = ka.shallow(g), l = 0, h.label = 1;
                                case 1:
                                    if (!(l < this._plugins.length)) return [3,
                                        7
                                    ];
                                    p = this._plugins[l];
                                    return "function" !== typeof p.requestWillBeUsed ? [3, 3] : [4, p.requestWillBeUsed("write", e, f)];
                                case 2:
                                    q = Ya.apply(void 0, [h.sent(), 2]), e = q[0], f = q[1], h.label = 3;
                                case 3:
                                ...
                                case 9:
                                    h.sent(), l = this._plugins.length - 1, h.label = 10;
                                case 10:
                                    if (!(0 <= l)) return [3, 13];
                                    p = this._plugins[l];
                ...
                b.prototype.evict = function(a, b, c) {
                    return K(this, void 0, void 0, function() {
                        ...
                        return E(this, function(g) {
                            switch (g.label) {
                                case 0:
                                    e = this._toInternalRequest(b), h = ka.shallow(c), d = 0, g.label =
                                        1;
                                case 1:
                                    if (!(d < this._plugins.length)) return [3, 4];
                                    f = this._plugins[d];
                                ...
                                case 2:
                                    k = Ya.apply(void 0, [g.sent(), 2]), e = k[0], h = k[1], g.label = 3;
                                case 3:
                                    return d++, [3, 1];
                                case 4:
                                    return [4, this._read(a, e, this._getInternalCacheQueryOptions())];
                        ...
                        return E(this, function(g) {
                            switch (g.label) {
                                ...
                                case 1:
                                    ...
                                    h = e.protocol;
                                    if ("http:" !== h && "https:" !== h) throw r.create("RequestURLSchemeNonHTTP", {
                                        scheme: h
                                    });
                                    P.validateIsUsable(c);
                                    P.validateIsOK(c);
                                ...
                                case 3:
                                    return g.sent(), [3, 5];
                                case 4:
                                    throw f = g.sent(), l = C.matchesSignature(f, ba.NETWORK_ERROR), this._metricsService.error(a, f, this._errorLoggingScope, l ? "ERROR" : void 0), this._metricsService.countError(a, f, l ? "".concat("NetworkError", ":").concat(this._errorLoggingScope) :
                                        this._errorLoggingScope), f;
                                case 5:
                                    return [2]
                            }
                        })
                        ...
                        return E(this, function(e) {
                            switch (e.label) {
                                ...
                                case 3:
                                    ...
                                    }, b), g = C.matchesSignature(b, ba.UNEXPECTED_INTERNAL_ERROR), this._metricsService.error(a, c, this._errorLoggingScope, g ? "ERROR" : void 0), [3, 4];
                                case 4:
                                    return [2]
                            }
                        })
                ...
                b.prototype._toInternalRequest = function(a) {
                    a = J.encode("string" ===
                        typeof a ? a : a.url);
                    a = "https://".concat(v.NAMESPACE_LCASE, "?key\x3d").concat(a);
                ...
                b._CACHE_NAME_PREFIX = v.NAMESPACE;
                D([k], b.prototype,
                    "read", null);
        ...
        var Ea;
        (function(f) {
            var b = "x-amz-".concat(v.NAMESPACE_LCASE, "-");
            ...
            f.removeLibHeaders = function(a) {
                return ua.removeHeadersWithPrefix(a, b)
            }
        })(Ea || (Ea = {}));
        var $a;
        (function(f) {
            var b = Ea.getLibHeader("client-version");
            f.appendClientVersion = function(a) {
                a.append(b, v.VERSION)
            }
        })($a || ($a = {}));
        var ab;
        (function(f) {
        ...
        var Wc = this && this.__extends || function() {
                var f = function(b, a) {
                    f = Object.setPrototypeOf || {
                        __proto__: []
                    }
            ...
            bb = function(f) {
                ...
                b.prototype.encodeHeaderValue = function(a) {
                    return J.encode(H.serialize(a))
                };
                b.prototype.decodeHeaderValue = function(a) {
                    return (a = J.decode(a)) ? H.deserialize(a) : void 0
                };
                ...
                va([k], b.prototype, "getName",
                    null);
                va([k], b.prototype, "getPrefixedHeaderName", null);
                va([k], b.prototype, "encodeHeaderValue", null);
                va([k], b.prototype, "decodeHeaderValue", null);
                va([k], b.prototype, "updateResponseHeaders", null);
                return b
            }(u),
            Xc = this && this.__extends || function() {
                var f = function(b, a) {
                    f = Object.setPrototypeOf || {
                        __proto__: []
                    }
            ...
            Pb = this && this.__awaiter || function(f, b, a, e) {
                function c(c) {
                    return c instanceof a ? c : new a(function(a) {
                        a(c)
                    })
            ...
            Qb = this && this.__generator || function(f, b) {
                function a(a) {
                    return function(c) {
                        return e([a, c])
                    }
            ...
            Yc = function(f) {
                ...
                Fa([k], b.prototype, "cacheWillUpdate", null);
                Fa([k], b.prototype, "responseWillBeUsed", null);
                Fa([k], b.prototype, "_getRequestStartTimestampSeconds", null);
                Fa([k], b.prototype, "_getMaxAgeSeconds", null);
                return b
            }(bb),
            ...
            cb = this && this.__assign || function() {
                cb = Object.assign || function(f) {
                    for (var b, a = 1, e = arguments.length; a < e; a++) {
                        b = arguments[a];
                        for (var c in b) Object.prototype.hasOwnProperty.call(b, c) && (f[c] = b[c])
                    }
            ...
            $c = function(f) {
                ...
                wa([k], b.prototype, "cacheWillUpdate", null);
                wa([k], b.prototype, "responseWillBeUsed", null);
                wa([k], b.prototype, "_getKeysFromOptions", null);
                wa([k], b.prototype, "_getKeysFromResponse", null);
                wa([k], b.prototype, "_doKeysMatch", null);
                return b
            }(bb),
            ad = this && this.__extends || function() {
                var f = function(b, a) {
                    f = Object.setPrototypeOf || {
                        __proto__: []
                    }
            ...
            db = this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
            ...
            bd = this && this.__awaiter || function(f, b, a, e) {
                function c(c) {
                    return c instanceof a ? c : new a(function(a) {
                        a(c)
                    })
            ...
            cd = this && this.__generator || function(f, b) {
                function a(a) {
                    return function(c) {
                        return e([a, c])
                    }
            ...
            dd = function(f) {
                ...
                b.prototype._getRequestStartTimestampSeconds = function(a) {
                    return a && "number" === typeof a.requestStartTimestampSeconds ? a.requestStartTimestampSeconds : F.getEpochSeconds()
                };
                b.prototype._getAttribution = function(a) {
                    return a && "string" === typeof a.attribution ? a.attribution : "unknown"
                };
                db([k], b.prototype, "cacheWillUpdate", null);
                db([k], b.prototype, "_getRequestStartTimestampSeconds",
                    null);
                db([k], b.prototype, "_getAttribution", null);
                return b
            }(bb),
            ed = this && this.__extends || function() {
                var f = function(b, a) {
                    f = Object.setPrototypeOf || {
                        __proto__: []
                    }
            ...
            Ga = this && this.__awaiter || function(f, b, a, e) {
                function c(c) {
                    return c instanceof a ? c : new a(function(a) {
                        a(c)
                    })
            ...
            Ha = this && this.__generator || function(f, b) {
                function a(a) {
                    return function(c) {
                        return e([a, c])
                    }
            ...
            fd = function(f) {
                ...
                b.prototype._initCacheOperators = function(a, b, c) {
                    ...
                    c.forEach(function(c) {
                        ...
                        e._cacheOperators[c.name] = new Vc(a, b, f, d, g, !h)
                    })
                };
                ...
                V([k], b.prototype, "read", null);
                V([k], b.prototype, "write", null);
                V([k], b.prototype, "evict", null);
                V([k], b.prototype, "exists", null);
                V([k], b.prototype,
                    "_getCacheOperator", null);
                V([k], b.prototype, "_initCacheOperators", null);
                V([k], b.prototype, "_createPluginInstance", null);
                V([k], b.prototype, "_validateNoDuplicateCaches", null);
                return b
            }(u),
            ...
            eb = this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
                    g = 3 > c ? b : null === e ? e = Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
                if ("object" === typeof Reflect && "function" === typeof Reflect.decorate) g = Reflect.decorate(f, b, a, e);
            ...
            Ia = function(f) {
                        ...
                        return Ub(this, function(e) {
                            switch (e.label) {
                                ...
                                case 1:
                                    c = e.sent();
                                    g = {};
                                    for (h = 0; h < a.length; h++) g[a[h]] = c[h];
                                    return [2, g]
                            }
                        })
                    })
                    ...
                    return Tb(this, void 0, void 0, function() {
                        ...
                        return Ub(this, function(d) {
                            switch (d.label) {
                                ...
                                case 3:
                                    return c = d.sent(), [2, this._getValueOrUnknown(c)];
                                case 4:
                                    return [4, this._customerContextService.getRecognition()];
                                case 5:
                                    return g = d.sent(), [2, this._getValueOrUnknown(g)];
                                case 6:
                                    return [4, this._customerContextService.getLanguage()];
                                case 7:
                                    return h = d.sent(), [2, this._getValueOrUnknown(h)];
                                case 8:
                ...
                eb([k], b.prototype, "compute", null);
                eb([k], b.prototype, "_getValueForKey", null);
                eb([k], b.prototype, "_getValueOrUnknown", null);
                return b
            }(u),
            ...
            id = function(f) {
                ...
                Vb([k], b.prototype, "stripRefMarkersFromPath", null);
                Vb([k], b.prototype, "stripLanguageFolderFromPath", null);
                return b
            }(u),
            ...
            Xb = function(f) {
                ...
                b.prototype.match =
                    function(a, b, c) {
                        return (a = I.parse(a.url)) ? this._pattern.test(this._getNormalizedPath(a.pathname)) : !1
                    };
                ...
                Wb([k], b.prototype, "match", null);
                Wb([k], b.prototype, "_getNormalizedPath", null);
                return b
            }(id),
            ...
            Ja = this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
                    g = 3 > c ? b : null === e ? e = Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
                if ("object" === typeof Reflect &&
            ...
            hb = function(f) {
                ...
                Ja([k], b.prototype, "getResponse", null);
                Ja([k], b.prototype, "getResponseText", null);
                Ja([k], b.prototype, "getResponseJson", null);
                Ja([k], b.prototype, "_getRequestInit", null);
                return b
            }(u),
            ...
            md = function(f) {
                ...
                b.prototype.prefetch = function(a, b, c) {
                    return ib(this, void 0, void 0, function() {
                        var e, h, d, f, l, p, k, q, r, v, u, Yb, Zb, w, x;
                        return jb(this, function(g) {
                            switch (g.label) {
                                case 0:
                                ...
                                case 6:
                                    ...
                                    u = this._getPrefetchURL(h, a.name, b.label);
                                    if (!u) return [2, {
                                        ok: !1,
                                        exitCode: "InvalidURL"
                                    }];
                                    Yb = F.getEpochSeconds();
                                    g.label = 7;
                                case 7:
                                    return g.trys.push([7, 9, , 10]), [4, (new hb(u, this._getPrefetchRequestInit())).getResponse()];
                                case 8:
                                    return Zb = g.sent(), [2, {
                                        ok: !0,
                                        requestStartTimestampSeconds: Yb,
                                        response: Zb
                                    }];
                                case 9:
                                    return w = g.sent(), x = C.matchesCode(w, "FailedToFetch"), this._metricsService.error(c, w, this._errorLoggingScope, x ? "ERROR" : void 0), this._metricsService.countError(c, w, x ? "".concat("FailedToFetch", ":").concat(this._errorLoggingScope) : this._errorLoggingScope), [2, {
                                        ok: !1,
                    ...
                    return ib(this, void 0, void 0, function() {
                        ...
                        return jb(this, function(h) {
                            switch (h.label) {
                                case 0:
                                    return d =
                                        (e = this._cacheService).exists, f = [g, a, b], l = {}, [4, (new Ia(this._customerContextService)).compute(c)];
                                case 1:
                                    return [2, d.apply(e, f.concat([(l.validationKeys = h.sent(), l)]))]
                            }
                        })
                    })
                };
                ...
                b.prototype._getPrefetchURL = function(a, e, c) {
                    if (a = I.parse(a, this._swGlobal.location.href)) {
                        var g = this._getPageShellClass(a);
                        this._addQueryParam(a, b._QUERY_PARAM_PAGE_SHELL, g);
                        this._addQueryParam(a, b._QUERY_PARAM_CACHE_POP_RULE,
                            e);
                ...
                b.prototype._getRefTag = function(a, e, c) {
                    return "".concat(b._REF_TAG_PREFIX, "_").concat(a.substr(0,
                        16).toLocaleLowerCase(), "_").concat(e.substr(0, 16).toLocaleLowerCase(), "_").concat(c.substr(0, 16).toLocaleLowerCase())
                };
                ...
                b._PAGE_SHELL_TYPE_DEFAULT =
                    "default";
                b._REF_TAG_PREFIX = v.NAMESPACE_SHORT;
                W([k], b.prototype, "prefetch", null);
                W([k], b.prototype, "_exists", null);
                W([k], b.prototype, "_hasPrefetchCredit", null);
                W([k], b.prototype, "_getPrefetchURL", null);
                W([k], b.prototype, "_addQueryParam", null);
                W([k], b.prototype, "_getPageShellClass", null);
                W([k], b.prototype, "_getRefTag", null);
                W([k], b.prototype, "_getPrefetchRequestInit", null);
                return b
            }(u),
            nd = function(f) {
                return A.div([A.style('body,html{font-family:"Amazon Ember",Arial,sans-serif;background:#fff}.main{position:fixed;bottom:0;left:0;right:0;padding:50px 0;text-align:center}.main-image{width:50%}.subline{font-size:.75rem;color:#999;margin:10px 0}.button{display:block;font-size:1rem;padding:10px;width:80%;margin:10px auto;border:1px solid #ccc;border-radius:5px;box-shadow:0 3px 0 #ccc;background:#fff}.button:active{border-color:#12626d;background-color:#edfcff}.hidden{display:none}'),
            ...
            Ka = this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
                    g = 3 > c ? b : null === e ? e = Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
                if ("object" === typeof Reflect && "function" === typeof Reflect.decorate) g = Reflect.decorate(f, b, a, e);
            ...
            wd = this && this.__awaiter || function(f, b, a, e) {
                function c(c) {
                    return c instanceof a ? c : new a(function(a) {
                        a(c)
                    })
            ...
            xd = this && this.__generator || function(f, b) {
                function a(a) {
                    return function(c) {
                        return e([a, c])
                    }
            ...
            ca = function(f) {
                ...
                b.prototype.getInit = function(a, b, c) {
                    ...
                    return {
                        status: a,
                        statusText: b,
                        headers: ua.getCommonHTMLHeaders(c)
                    }
                };
                b.prototype.renderTemplate = function(a, b) {
                    ...
                    return M.isDebug ? ["", "\x3c!-- ".concat(v.NAMESPACE, ":Feature:").concat(this.NAME, " --\x3e"), c, "\x3c!-- ".concat(v.NAMESPACE, ":EndFeature:").concat(this.NAME, " --\x3e"), ""].join("\n") :
                        c
                };
                b.prototype.getErrorLoggingScope = function() {
                    return "".concat(this.NAME, "ResponseTransmog")
                };
                Ka([k], b.prototype, "getResponse", null);
                Ka([k], b.prototype, "getInit", null);
                Ka([k], b.prototype, "renderTemplate", null);
                Ka([k], b.prototype, "getErrorLoggingScope", null);
                return b
            }(u),
            ...
            zd = function(f) {
                                ...
                                function() {
                                    return lb(this, function(a) {
                                        switch (a.label) {
                                            ...
                                            case 1:
                                                return a.sent(), [4, this._toOutputStream(this._getWrappedSerializedData(), b)];
                                            case 2:
                                                return a.sent(), b.close(), [2]
                                        }
                                    })
                                })
                        }
                ...
                b.prototype._toOutputStream = function(a, b) {
                    return kb(this, void 0, void 0, function() {
                        ...
                        return lb(this, function(e) {
                            switch (e.label) {
                                case 0:
                                    return "string" === typeof a ? (c = this._textEncoder.encode(a), b.enqueue(c), [2]) : a.body instanceof ReadableStream ? [4, la.drain(a.body,
                                        function(a) {
                                            b.enqueue(a)
                                        })] : [2];
                                case 1:
                ...
                b.prototype._getWrappedSerializedData = function() {
                    try {
                        var a = ka.deep.json(this._serializableData)
                    } catch (e) {
                        this.metricsService.countError(this.eventOptions, r.create("SerializationFailed"), this.getErrorLoggingScope()), a = {}
                    }
                    return this.renderTemplate(od, {
                        namespace: v.NAMESPACE,
                        globalObjectName: "$".concat(v.NAMESPACE),
                        contentFragmentName: this._name,
                        contentFragmentData: a
                    })
                };
                La([k], b.prototype, "transmog", null);
                La([k], b.prototype, "_getOutputStream",
                    null);
                La([k], b.prototype, "_toOutputStream", null);
                La([k], b.prototype, "_getWrappedSerializedData", null);
                return b
            }(ca),
            Ad = this && this.__extends || function() {
                var f = function(b, a) {
            ...
            na = function(f) {
                ...
                b.prototype._getClonedResponse = function(a) {
                    try {
                        ...
                        throw a =
                            r.wrap(e, "ResponseClone"), this.metricsService.error(this.eventOptions, a, this.getErrorLoggingScope()), this.metricsService.countError(this.eventOptions, a, this.getErrorLoggingScope()), a;
                    }
                };
                mb([k], b.prototype, "getSource", null);
                mb([k], b.prototype, "getSourceInit", null);
                mb([k], b.prototype, "_getClonedResponse", null);
                return b
            }(ca),
            ...
            Dd = this && this.__generator || function(f,
                b) {
                function a(a) {
                    return function(b) {
                        return e([a, b])
            ...
            Ed = function(f) {
                ...
                b.prototype._getHTML = function(a) {
                    ...
                    return a += this.renderTemplate($b, {
                        markers: this.markers.map(function(a) {
                            return "".concat(a, ".").concat(v.NAMESPACE_LCASE)
                        })
                    })
                };
                b.prototype._replaceMarkers = function(a) {
                    ...
                    this.markers.forEach(function(a) {
                        try {
                            var e = new RegExp(Wa.escapeRegExp(b._getAUILoaderWithMarkerString(a)), "g");
                            c = c.replace(e, b._getAUILoaderWithMarkerString("".concat(a, ".").concat(v.NAMESPACE_LCASE)))
                        } catch (d) {
                ...
                nb([k], b.prototype, "transmog", null);
                nb([k], b.prototype, "_getHTML", null);
                nb([k], b.prototype, "_replaceMarkers", null);
                return b
            }(na),
            ...
            ac = this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
                    g = 3 > c ? b : null === e ? e = Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
                if ("object" === typeof Reflect &&
            ...
            ob = this && this.__awaiter || function(f, b, a, e) {
                function c(b) {
                    return b instanceof a ? b : new a(function(a) {
                        a(b)
                    })
            ...
            Gd = function(f) {
                        ...
                        return pb(this, function(f) {
                            switch (f.label) {
                                ...
                                case 1:
                                    e = f.sent(), f.label = 2;
                                case 2:
                                    return f.trys.push([2, 4, , 5]), [4, S.replaceAsync(e,
                                        b.NEEDLE_PATTERN,
                                        function(a, b) {
                                            return ob(d, void 0, void 0, function() {
                                ...
                                case 3:
                                    return c = f.sent(), [3, 5];
                                case 4:
                                    return g = f.sent(), h = C.matchesCode(g, "FailedToFetch"), this.metricsService.error(this.eventOptions, g, this.getErrorLoggingScope(), h ? "ERROR" : void 0), this.metricsService.countError(this.eventOptions, g, h ? "".concat("FailedToFetch", ":").concat(this.getErrorLoggingScope()) : this.getErrorLoggingScope()), c = e, [3, 5];
                                case 5:
                                    return [2, new Response(c,
                                        this.getSourceInit())]
                            }
                        })
                    })
                ...
                b.prototype._getInlinedStyles = function(a) {
                    return ob(this, void 0, void 0, function() {
                        ...
                        return pb(this, function(c) {
                            switch (c.label) {
                                case 0:
                                    return [4, (new hb(a)).getResponseText()];
                                case 1:
                                    return b = c.sent(), [2, this.renderTemplate(rd, {
                                        stylesheetUrl: a,
                                        stylesheetContent: b
                                    })]
                            }
                ...
                ac([k], b.prototype, "transmog", null);
                ac([k], b.prototype, "_getInlinedStyles", null);
                return b
            }(na),
            Hd = this && this.__extends || function() {
                var f =
            ...
            Id = this && this.__awaiter || function(f, b, a, e) {
                function c(b) {
                    return b instanceof a ? b : new a(function(a) {
                        a(b)
                    })
            ...
            Jd = this && this.__generator || function(f, b) {
                function a(a) {
                    return function(b) {
                        return e([a, b])
                    }
            ...
            Kd = function(f) {
                ...
                b.prototype.transmog = function() {
                    return Id(this, void 0, void 0, function() {
                        var a, b;
                        return Jd(this, function(c) {
                            switch (c.label) {
                                case 0:
                                    return a = this.getSource(), [4, a.text()];
                                case 1:
                                    return b = c.sent(), [2, new Response(this._getHTML(b),
                                        this.getSourceInit())]
                            }
                        })
                    })
                ...
                b.LOAD_JS_REPLACER = "sp.load.js.".concat(v.NAMESPACE_LCASE);
                b.CRIT_LOAD_JS_PATTERN = /\bsp\.load\.critical\.js\b/g;
                b.CRIT_LOAD_JS_REPLACER = "sp.load.critical.js.".concat(v.NAMESPACE_LCASE);
                bc([k], b.prototype, "transmog",
                    null);
                bc([k], b.prototype, "_getHTML", null);
                return b
            }(na),
            Ld = this && this.__extends || function() {
                var f = function(b, a) {
                ...
                return function(b, a) {
                    ...
                    f(b, a);
                    b.prototype = null === a ?
                        Object.create(a) : (e.prototype = a.prototype, new e)
                }
            }(),
            qb = this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
                    g = 3 > c ? b : null === e ? e = Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
                if ("object" === typeof Reflect && "function" === typeof Reflect.decorate) g = Reflect.decorate(f, b, a, e);
            ...
            Md = this && this.__awaiter || function(f, b, a, e) {
                function c(b) {
                    return b instanceof a ? b : new a(function(a) {
                        a(b)
                    })
            ...
            Nd = this && this.__generator || function(f, b) {
                function a(a) {
                    return function(b) {
                        return e([a, b])
                    }
            ...
            Od = function(f) {
                ...
                Ld(b, f);
                b.prototype.transmog = function() {
                    return Md(this, void 0, void 0,
                        function() {
                            var a, e, c, g, h, d;
                            return Nd(this, function(f) {
                                switch (f.label) {
                                    case 0:
                                        a = this.getSource();
                                        e = a.headers.get(x.shared.REQUEST_ID_OPF_HEADER);
                                        if (!e) return [2, new Response(a.body, this.getSourceInit())];
                                        c = "".concat(b.SYNTHETIC_PREFIX).concat(S.generateRandomSequence(b.SEQUENCE_LENGTH, b.SEQUENCE_RADIX)).toUpperCase();
                                        return [4, a.text()];
                                    case 1:
                ...
                b.SYNTHETIC_PREFIX = v.NAMESPACE_UCASE;
                b.SEQUENCE_LENGTH = 20 - b.SYNTHETIC_PREFIX.length;
                b.SEQUENCE_RADIX = 36;
                qb([k], b.prototype, "transmog", null);
                qb([k], b.prototype, "_getHTML", null);
                qb([k], b.prototype, "_getResponseInit",
                    null);
                return b
            }(na),
            ...
            Rd = this && this.__awaiter || function(f, b, a, e) {
                function c(b) {
                    return b instanceof a ? b : new a(function(a) {
                        a(b)
                    })
            ...
            Sd = this && this.__generator || function(f, b) {
                function a(a) {
                    return function(b) {
                        return e([a, b])
                    }
            ...
            cc = function(f) {
                ...
                b.prototype.transmog = function() {
                    return Rd(this, void 0, void 0, function() {
                        ...
                        return Sd(this,
                            function(e) {
                                a = I.parse(this._pageUrl);
                                b = "".concat(v.NAMESPACE_LCASE, "Debug");
                                c = !!a && a.searchParams.has(b) && M.isDebug;
                                return [2, new Response(c ? this.renderTemplate(qd, {
                                    namespace: v.NAMESPACE,
                                    globalObjectName: "$".concat(v.NAMESPACE),
                                    learnMoreLink: v.HELP_LINK
                                }) : "", this.getInit())]
                            })
                    })
                };
                Qd([k], b.prototype, "transmog", null);
                return b
            }(ca),
            ...
            sb = this && this.__generator || function(f,
                b) {
                function a(a) {
                    return function(b) {
                        return e([a, b])
            ...
            dc = function(f) {
                ...
                b.prototype.transmog = function() {
                    return rb(this, void 0, void 0, function() {
                        var a, b;
                        return sb(this, function(c) {
                            a = this.getSource();
                            b = a.body;
                            return [2,
                                new Response(this._getOutputStream(b), this._getResponseInit())
                            ]
                        })
                    })
                };
                ...
                b.prototype._getOutputStream = function(a) {
                    ...
                    return new ReadableStream({
                        start: function(c) {
                            return rb(b, void 0, void 0, function() {
                ...
                b.prototype._toOutputStream = function(a, b) {
                    return rb(this, void 0, void 0, function() {
                        ...
                        return sb(this, function(g) {
                            switch (g.label) {
                                case 0:
                                    return g.trys.push([0, 2, , 3]), [4, la.drain(a, function(a) {
                                        d.processChunk(b, a)
                                    })];
                                case 1:
                                    g.sent();
                                    ...
                                    return [3, 3];
                                case 2:
                                    return c = g.sent(), e = r.wrap(c, "StreamTransform", void 0, 'Stream processing failed while running "'.concat(this.NAME,
                                        '" transmog')), h = C.matchesSignature(c, ba.NETWORK_ERROR), this.metricsService.error(this.eventOptions, e, this.getErrorLoggingScope(), h ? "ERROR" : void 0), this.metricsService.countError(this.eventOptions, e, h ? "".concat("NetworkError", ":").concat(this.getErrorLoggingScope()) : this.getErrorLoggingScope()), b.error(e), [3, 3];
                                case 3:
                                    return [2]
                            }
                        })
                ...
                b.prototype._getResponseInit = function() {
                    ...
                    b.append(x.shared.getClientOnlyLibHeader(this.needleHeaderKey),
                        J.encode(this.needle));
                    a.headers = b;
                    return a
                };
                da([k], b.prototype, "transmog", null);
                da([k], b.prototype, "decode", null);
                da([k], b.prototype, "encode", null);
                da([k], b.prototype, "scan", null);
                da([k], b.prototype, "_getOutputStream", null);
                da([k], b.prototype, "_toOutputStream", null);
                da([k], b.prototype, "_getResponseInit", null);
                return b
            }(na),
            ...
            Vd = this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
                    g = 3 > c ? b : null === e ? e = Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
                if ("object" === typeof Reflect && "function" === typeof Reflect.decorate) g = Reflect.decorate(f,
            ...
            Wd = function(f) {
                ...
                Vd([k], b.prototype, "processChunk", null);
                return b
            }(dc),
            Xd = this && this.__extends || function() {
                var f = function(b, a) {
                    f = Object.setPrototypeOf || {
                        __proto__: []
                    }
            ...
            Yd = this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
                    g = 3 > c ? b : null === e ? e = Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
                if ("object" === typeof Reflect && "function" === typeof Reflect.decorate) g = Reflect.decorate(f, b, a, e);
            ...
            ec = this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
                    g = 3 > c ? b : null === e ? e = Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
                if ("object" === typeof Reflect && "function" === typeof Reflect.decorate) g = Reflect.decorate(f, b, a, e);
            ...
            ae = this && this.__awaiter || function(f, b, a, e) {
                function c(b) {
                    return b instanceof a ? b : new a(function(a) {
                        a(b)
                    })
            ...
            be = this && this.__generator || function(f, b) {
                function a(a) {
                    return function(b) {
                        return e([a, b])
                    }
            ...
            ce = function(f) {
                    ...
                    function() {
                        return ae(this, void 0, void 0, function() {
                            return be(this, function(a) {
                                return [2, new Response(this.renderTemplate(nd, {
                ...
                b.prototype._getSafeUrl = function(a) {
                    return a ? I.encode(a) || "unknown" : ""
                };
                b.HTML_FALLBACK_UI_TIMEOUT = 500;
                ec([k], b.prototype, "transmog", null);
                ec([k], b.prototype,
                    "_getSafeUrl", null);
                return b
            }(ca),
            ...
            ee = this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
                    g = 3 > c ? b : null === e ? e = Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
                if ("object" === typeof Reflect && "function" === typeof Reflect.decorate) g = Reflect.decorate(f, b, a, e);
            ...
            he = function(f) {
                ...
                b.prototype.transmog = function() {
                    return fe(this, void 0, void 0, function() {
                        ...
                        return ge(this, function(e) {
                            ...
                            return [2, new Response(this.renderTemplate(pd, {
                                namespace: v.NAMESPACE,
                                requestId: b,
                ...
                ee([k], b.prototype, "transmog", null);
                return b
            }(na),
            ...
            ke = this && this.__awaiter || function(f, b, a, e) {
                function c(b) {
                    return b instanceof a ? b : new a(function(a) {
                        a(b)
                    })
            ...
            le = this && this.__generator || function(f, b) {
                function a(a) {
                    return function(b) {
                        return e([a, b])
                    }
                    ...
                    function() {
                        return ke(this, void 0, void 0, function() {
                            return le(this, function(a) {
                                return [2, new Response(this.renderTemplate(sd, {
                                    namespace: v.NAMESPACE,
                                    hit: !0,
                                    meta: {
                                    ...
                                    globalObjectName: "$".concat(v.NAMESPACE),
                                    pModulePrefix: "".concat(v.NAMESPACE_LCASE, "-")
                                }), this.getInit())]
                            })
                        })
                    };
            ...
            oe = this && this.__awaiter || function(f, b, a, e) {
                function c(b) {
                    return b instanceof a ? b : new a(function(a) {
                        a(b)
                    })
            ...
            pe = this && this.__generator || function(f, b) {
                function a(a) {
                    return function(b) {
                        return e([a, b])
                    }
            ...
            qe = function(f) {
                ...
                b.prototype.transmog = function() {
                    return oe(this, void 0, void 0, function() {
                        return pe(this,
                            function(a) {
                                return [2, new Response(this.renderTemplate(ud, {
                                    namespace: v.NAMESPACE,
                ...
                ne([k], b.prototype, "transmog", null);
                return b
            }(ca),
            re = this && this.__extends || function() {
                var f = function(b, a) {
                    f = Object.setPrototypeOf || {
                        __proto__: []
                    }
            ...
            tb = this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
                    g = 3 > c ? b : null === e ? e = Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
                if ("object" === typeof Reflect && "function" === typeof Reflect.decorate) g = Reflect.decorate(f, b, a, e);
            ...
            se = this && this.__awaiter || function(f, b, a, e) {
                function c(b) {
                    return b instanceof a ? b : new a(function(a) {
                        a(b)
                    })
            ...
            te = this && this.__generator || function(f, b) {
                function a(a) {
                    return function(b) {
                        return e([a, b])
                    }
            ...
            ue = function(f) {
                ...
                b.prototype.transmog = function() {
                    return se(this, void 0, void 0, function() {
                        return te(this, function(a) {
                            return [2, this._useHTTPStatusCodesForRedirects ? Response.redirect(this._getTargetURL(), b.HTTP_REDIRECT_STATUS_CODE) : new Response(this.renderTemplate(td, {
                                useMash: R.isMShop(),
                ...
                tb([k], b.prototype, "transmog", null);
                tb([k], b.prototype, "_getTargetURL", null);
                tb([k], b.prototype, "_getSkipInterceptParamName", null);
                return b
            }(ca),
            ...
            we = this && this.__read || function(f, b) {
                var a = "function" === typeof Symbol && f[Symbol.iterator];
                if (!a) return f;
                f = a.call(f);
                var e, c = [];
            ...
            xe = function(f) {
                ...
                b.prototype.write = function(a, b, c) {
                    return gc(this, void 0, void 0, function() {
                        var e, h, d, f, l, p, k, q, r, t, v, u;
                        return hc(this, function(g) {
                            switch (g.label) {
                                case 0:
                                    return g.trys.push([0, 3, , 4]), e = b.storage, h = e.cacheName, d = e.cacheKey, f = e.maxAge, l = e.validationKeys, [4, Promise.all([this._getTransmoggedResponse(a, b.transmogs, c), (new Ia(this._customerContextService)).compute(l)])];
                                case 1:
                                    return p = we.apply(void 0, [g.sent(), 2]), k = p[0], q = p[1], [4, this._cacheService.write(c.eventOptions, h, d, k, {
                                        maxAgeSeconds: f,
                                ...
                                case 2:
                                    return g.sent(), [3, 4];
                                case 3:
                                    throw r = g.sent(), t = C.matchesSignature(r, ba.FAILED_TO_FETCH), v = C.matchesSignature(r, ba.NETWORK_ERROR), u = t || v || !1, this._metricsService.error(c.eventOptions, r, this._errorLoggingScope, u ? "ERROR" : void 0), this._metricsService.countError(c.eventOptions, r, t ? "".concat("FailedToFetch", ":").concat(this._errorLoggingScope) : v ? "".concat("NetworkError", ":").concat(this._errorLoggingScope) : this._errorLoggingScope), r;
                                case 4:
                                    return [2]
                            }
                        })
                ...
                b.prototype._getTransmog = function(a, b, c) {
                    switch (b.name) {
                        case "BeforeSingleDelimiter":
                            return new Zd(c.eventOptions, this._metricsService, a, b.delimiter, b.delimiterKey,
                                b.inclusive);
                        case "EagerLoadJSMarker":
                            return new Ed(c.eventOptions, this._metricsService, a, b.markers);
                        case "InlinedStylesheet":
                            return new Gd(c.eventOptions, this._metricsService, a);
                        case "ShoppingPortalLoadJSMarker":
                            return new Kd(c.eventOptions, this._metricsService, a);
                        case "SyntheticRequestId":
                            return new Od(c.eventOptions, this._metricsService, a);
                        default:
                            throw r.create("UnrecognizedTransmog", b);
                    }
                };
                ub([k], b.prototype, "write", null);
                ub([k], b.prototype, "_getTransmoggedResponse", null);
                ub([k], b.prototype, "_getTransmog",
                    null);
                return b
            }(u),
            ...
            ic = this && this.__awaiter || function(f, b, a, e) {
                function c(b) {
                    return b instanceof a ? b : new a(function(a) {
                        a(b)
                    })
            ...
            jc = this && this.__generator || function(f, b) {
                function a(a) {
                    return function(b) {
                        return e([a, b])
                    }
            ...
            kc = function(f) {
                ...
                b.prototype.isResponseValidForCaching = function(a, b) {
                    return ic(this, void 0, void 0, function() {
                        var c;
                        return jc(this, function(e) {
                            switch (e.label) {
                                case 0:
                                    try {
                                        P.validateIsUsable(a),
                                            P.validateIsOK(a)
                                    } catch (h) {
                                        return [2, {
                                            valid: !1,
                ...
                b.prototype._isAXModeContent = function(a) {
                    return ic(this, void 0, void 0, function() {
                        ...
                        return jc(this, function(e) {
                            switch (e.label) {
                                case 0:
                                    return b = [/ue_sid\s*=\s*['"]000-0000000-8675309['"]/gi, /\/1\/batch\/1\/OP\/[A-Z0-9]+:000-0000000-8675309:/gi], [4, P.matchPatterns(a.clone(), b)];
                                case 1:
                ...
                xa([k], b.prototype, "logTagAndCount", null);
                xa([k], b.prototype, "logMark", null);
                xa([k], b.prototype, "isResponseValidForCaching", null);
                xa([k], b.prototype, "_skipCachingAXModeContent", null);
                xa([k], b.prototype, "_isAXModeContent", null);
                return b
            }(u),
            ...
            vb =
            this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
                    g = 3 > c ? b : null === e ? e = Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
                if ("object" === typeof Reflect && "function" === typeof Reflect.decorate) g = Reflect.decorate(f, b, a, e);
            ...
            Ce = function(f) {
                function b(a, b, c, g, h) {
                    ...
                    d.NAME = "Prefetch";
                    d.logCtor(arguments);
                    d._prefetchExecutor = new md(a, b, c, g);
                    return d
                }
                ze(b, f);
                b.prototype.run = function(a) {
                    ...
                    c.errorContext.CachePopulationRulesForPrefetchOnRouteTrigger =
                        H.serialize(g);
                    g.forEach(function(e) {
                        var d = e.rule,
                            g = e.trigger;
                        t.queueTask(function() {
                            return Ae(b, void 0, void 0, function() {
                                var b, e;
                ...
                b.prototype._createPrefetchOnRouteMatcher = function(a) {
                    switch (a.routeMatcher.name) {
                        case "URLPathRoute":
                            return a = a.routeMatcher, new Xb(a.pattern, a.stripRefMarkers, a.stripLanguageFolder);
                        default:
                            throw r.create("UnrecognizedRouteMatcher", a.routeMatcher);
                    }
                };
                vb([k], b.prototype, "run", null);
                vb([k], b.prototype, "_getMatchingRulesForTrigger",
                    null);
                vb([k], b.prototype, "_createPrefetchOnRouteMatcher", null);
                return b
            }(kc),
            De = this && this.__extends || function() {
                var f = function(b, a) {
            ...
            lc = this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
                    g = 3 > c ? b : null === e ? e = Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
                if ("object" === typeof Reflect && "function" === typeof Reflect.decorate) g = Reflect.decorate(f, b, a, e);
            ...
            Ee = this && this.__awaiter || function(f, b, a, e) {
                function c(b) {
            ...
            Fe = this && this.__generator || function(f, b) {
                function a(a) {
                    return function(b) {
                        return e([a, b])
                    }
            ...
            Ge = function(f) {
                ...
                b.prototype.run = function(a) {
                    ...
                    g.errorContext.CachePopulationRulesForResponseRuleNavigationUpdateTrigger = H.serialize(a);
                    a.forEach(function(a) {
                        var c = a.rule,
                            d = a.trigger;
                        b.logMark(c, d, g, "Trigger:Start");
                        t.queueTask(function() {
                            return Ee(b, void 0, void 0, function() {
                                var a;
                                return Fe(this, function(b) {
                                    switch (b.label) {
                                        ...
                                        case 1:
                                            a = b.sent();
                                            if (!a.valid) return this.logTagAndCount(c,
                                                d, g, "Fail:Invalid:".concat(a.reason)), [2];
                                            b.label = 2;
                                        case 2:
                                            return b.trys.push([2, 4, , 5]), this.logMark(c, d, g, "Write:Start"), [4, this.cacheWriter.write(h.clone(), c, {
                                                eventOptions: g,
                                                requestStartTimestampSeconds: F.getEpochSeconds(g.timeOriginEpoch),
                                                attribution: d.label
                                            })];
                                        case 3:
                                            return b.sent(), this.logMark(c, d, g, "Write:Success"), this.logTagAndCount(c, d, g, "Success"), [3, 5];
                                        case 4:
                                            return b.sent(), this.logMark(c, d, g, "Write:Fail"), this.logTagAndCount(c, d, g, "Fail:Write"), [3, 5];
                                        case 5:
                                            return [2]
                                    }
                                })
                ...
                lc([k], b.prototype, "run", null);
                lc([k], b.prototype, "_getMatchingRulesForTrigger", null);
                return b
            }(kc),
            He = this && this.__extends || function() {
                var f = function(b, a) {
                    f = Object.setPrototypeOf || {
                        __proto__: []
                    }
            ...
            Ie = this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
                    g = 3 > c ? b : null === e ? e = Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
                if ("object" === typeof Reflect &&
            ...
            Je = function(f) {
                function b(a, b, c, g, h, d) {
                    var e = f.call(this) || this;
                    e.logCtor(arguments);
                    e._responseRuleNavigationUpdateTrigger = new Ge(b, c, g, d);
                    e._prefetchOnRouteTrigger = new Ce(a, b, c, g, d);
                ...
                Ie([k], b.prototype, "notifyEvent", null);
                return b
            }(u),
            ...
            mc = function(f) {
                ...
                ea([k], b.prototype,
                    "get", null);
                ea([k], b.prototype, "set", null);
                ea([k], b.prototype, "delete", null);
                ea([k], b.prototype, "has", null);
                ea([k], b.prototype, "size", null);
                ea([k], b.prototype, "full", null);
                ea([k], b.prototype, "keys", null);
                return b
            }(u),
            ...
            Me = this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
                    g = 3 > c ? b : null === e ? e = Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
                if ("object" === typeof Reflect && "function" === typeof Reflect.decorate) g = Reflect.decorate(f, b, a, e);
            ...
            Ne = this && this.__values || function(f) {
            ...
            wb = function(f) {
                ...
                b.prototype.evict = function() {
                    var a;
                    try {
                        for (var b = Ne(f.prototype.keys.call(this)), c = b.next(); !c.done; c = b.next()) {
                            var g = c.value;
                            if (!f.prototype.full.call(this)) break;
            ...
            Pe = this && this.__values || function(f) {
                var b = "function" === typeof Symbol && Symbol.iterator,
                    a = b && f[b],
                    e = 0;
                if (a) return a.call(f);
            ...
            Qe = function(f) {
                ...
                b.prototype.evict = function() {
                    var a;
                    try {
                        for (var b = Pe(f.prototype.keys.call(this)), c = b.next(); !c.done; c = b.next()) {
                            var g = c.value;
                            if (!f.prototype.full.call(this)) break;
                            f.prototype.delete.call(this, g)
                        }
                ...
                xb([k], b.prototype, "get", null);
                xb([k], b.prototype, "set", null);
                xb([k], b.prototype, "evict", null);
                return b
            }(mc),
            Re = this && this.__extends || function() {
                var f = function(b, a) {
            ...
            Se = this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
                    g = 3 > c ? b : null === e ? e = Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
                if ("object" === typeof Reflect && "function" === typeof Reflect.decorate) g = Reflect.decorate(f, b, a, e);
            ...
            nc = function(f) {
                ...
                Se([k], b.prototype, "notify", null);
                return b
            }(u),
            Te = this && this.__extends || function() {
                var f = function(b, a) {
                    f = Object.setPrototypeOf || {
                        __proto__: []
                    }
            ...
            Ue = function(f) {
                function b(a) {
                    var e =
                        f.call(this, a) || this;
                    e.logCtor(arguments);
                    e._readyStore = new wb(b._MAX_CLIENTS);
                    return e
                }
                Te(b, f);
                ...
                b._MAX_CLIENTS = 50;
                yb([k], b.prototype, "isClientReady", null);
                yb([k], b.prototype,
                    "accepts", null);
                yb([k], b.prototype, "publish", null);
                return b
            }(nc),
            Ve = this && this.__extends || function() {
                var f = function(b, a) {
            ...
            oc = this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
                    g = 3 > c ? b : null === e ? e = Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
                if ("object" === typeof Reflect && "function" === typeof Reflect.decorate) g = Reflect.decorate(f, b, a, e);
            ...
            We = function(f) {
                ...
                oc([k], b.prototype, "accepts", null);
                oc([k], b.prototype, "publish", null);
                return b
            }(nc),
            Xe = this && this.__extends || function() {
                var f = function(b, a) {
                    f = Object.setPrototypeOf || {
                        __proto__: []
                    }
            ...
            pc = this && this.__awaiter || function(f, b, a, e) {
                function c(b) {
                    return b instanceof a ? b : new a(function(a) {
                        a(b)
                    })
            ...
            Ye = function(f) {
                function b(a, b) {
                    ...
                    c.logCtor(arguments);
                    c._swGlobal = a;
                    c._clientReadyPublisher = new Ue(b);
                    c._renderingHintsPublisher = new We(b);
                    ...
                    return pc(this, void 0, void 0, function() {
                        ...
                        return qc(this, function(e) {
                            switch (e.label) {
                                ...
                                case 1:
                                    return c = e.sent(), this.postMessageToClient(c, b), [2]
                            }
                        })
                    })
                };
                b.prototype._listenForClientMessages =
                    function() {
                        var a = this;
                        this._swGlobal.addEventListener("message", function(b) {
                            if (a._filter(b)) {
                ...
                oa([k], b.prototype, "isClientReady", null);
                oa([k], b.prototype, "getClient", null);
                oa([k], b.prototype, "postMessageToClient", null);
                oa([k], b.prototype, "postMessageToClientById", null);
                oa([k], b.prototype, "_listenForClientMessages", null);
                oa([k], b.prototype, "_filter", null);
                return b
            }(u),
            Ze = this && this.__extends || function() {
                var f = function(b, a) {
            ...
            Na = function(f) {
                ...
                Ma([k], b.prototype, "filter", null);
                Ma([k], b.prototype, "isValidRouteMatcher", null);
                Ma([k], b.prototype, "isValidValidationKeys", null);
                Ma([k], b.prototype, "isValidForHeaderField", null);
                return b
            }(u),
            ...
            af = this && this.__decorate || function(f, b, a, e) {
                var c =
                    arguments.length,
                    g = 3 > c ? b : null === e ? e = Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
            ...
            df = this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
                    g = 3 > c ? b : null === e ? e = Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
                if ("object" === typeof Reflect && "function" === typeof Reflect.decorate) g = Reflect.decorate(f, b, a, e);
            ...
            ef = function(f) {
                ...
                df([k], b.prototype, "isValid", null);
                return b
            }(Na),
            ff = this && this.__extends || function() {
                var f = function(b, a) {
                    f = Object.setPrototypeOf || {
                        __proto__: []
                    }
            ...
            gf = function(f) {
                ...
                pa([k], b.prototype, "isValid", null);
                pa([k], b.prototype, "_isValidTrigger", null);
                pa([k], b.prototype, "_isValidPrefetch", null);
                pa([k], b.prototype, "_isValidTransmog", null);
                pa([k], b.prototype, "_isValidStorage", null);
                pa([k], b.prototype, "_isValidFlags", null);
                return b
            }(Na),
            hf = this && this.__extends || function() {
                var f = function(b, a) {
                    f = Object.setPrototypeOf || {
                        __proto__: []
                    }
            ...
            jf = function(f) {
                ...
                b.prototype._isValidResponseStrategy = function(a) {
                    ...
                    switch (a.name) {
                        ...
                        case "FullPage":
                            return c(a.cachedPage) &&
                                g(a.cachedPage.cacheName) && g(a.cachedPage.cacheKey) && this.isValidValidationKeys(a.cachedPage.validationKeys) && h(a.flags, c(a.flags) && f(Object.keys(a.flags), function(b) {
                                    var c = a.flags[b];
                ...
                b.prototype._isValidSkeleton = function(a) {
                    ...
                    return f(a, !!a && c(a) && h(a.name) && f(a.prewarm, l(a.prewarm, ["http-cache",
                        "memory", "none"
                    ])) && f(a.race, g(a.race)) && f(a.data, c(a.data)) && c(a.hooks) && p(Object.keys(a.hooks), function(c) {
                ...
                b.prototype._isValidSkeletonHook = function(a) {
                    ...
                    return d(Object.keys(a), function(b) {
                        var e = a[b];
                        return h(b, ["whenAny"]) && d(Object.keys(e),
                            function(a) {
                                var b = e[a];
                ...
                ya([k], b.prototype, "isValid",
                    null);
                ya([k], b.prototype, "_isValidWeblabTrigger", null);
                ya([k], b.prototype, "_isValidResponseStrategy", null);
                ya([k], b.prototype, "_isValidSkeleton", null);
                ya([k], b.prototype, "_isValidSkeletonHook", null);
                return b
            }(Na),
            ...
            Ab = this && this.__generator || function(f, b) {
                function a(a) {
                    return function(b) {
                        return e([a, b])
                    }
            ...
            lf = function(f) {
                function b(a, e, c) {
                    ...
                    g._memoryCache = new Qe(b._MAX_MEMORY_CACHE_ENTRIES);
                    g._init(c, e);
                    return g
                }
                kf(b, f);
                b.prototype.render = function(a, b, c) {
                    return zb(this, void 0, void 0, function() {
                        ...
                        return Ab(this, function(d) {
                            switch (d.label) {
                                case 0:
                                    return e = this._getContentFragmentConfig(b), e ? (h = this._fetchFromMemory(e.name)) ? [3, 2] : [4, this._fetchFromNetwork(a, e)] : [2];
                                case 1:
                                    h = d.sent(), d.label = 2;
                                case 2:
                                    return h ? [2, (new zd(a, this._metricsService, b,
                                        h, c)).getResponse()] : [2]
                            }
                        })
                    })
                ...
                b.prototype.prewarm = function(a, b, c) {
                    ...
                    if (h) switch (c) {
                        ...
                        case "memory":
                            t.queueTask(function() {
                                return zb(e, void 0, void 0, function() {
                                    var d;
                                    return Ab(this, function(e) {
                                        switch (e.label) {
                                            ...
                                            case 1:
                                                return d = e.sent(), "memory" === c && this._cacheInMemory(b, d), [2]
                                        }
                                    })
                                })
                            })
                ...
                b.prototype.notifyEvent = function(a) {
                    switch (a.name) {
                        case "ContentFragmentSpeculation":
                            this.prewarm(a.detail.eventOptions,
                                a.detail.name, a.detail.prewarm)
                    }
                };
                b.prototype._fetchFromNetwork = function(a, b, c) {
                    ...
                    return zb(this, void 0, void 0, function() {
                        ...
                        return Ab(this, function(g) {
                            switch (g.label) {
                                case 0:
                                    return g.trys.push([0, 2, , 3]), [4, (new hb(b.url)).getResponse()];
                                case 1:
                                    return [2, g.sent()];
                                case 2:
                                    return e = g.sent(), this._metricsService.countError(a, e, c ? "".concat(this._errorLoggingScope, ":Prewarming") : this._errorLoggingScope), [2];
                                case 3:
                                    return [2]
                            }
                        })
                ...
                b.prototype._fetchFromMemory = function(a) {
                    return (a = this._memoryCache.get(a)) ?
                        a.clone() : void 0
                };
                ...
                X([k], b.prototype, "render", null);
                X([k], b.prototype, "prewarm", null);
                X([k], b.prototype, "notifyEvent", null);
                X([k], b.prototype, "_fetchFromNetwork", null);
                X([k], b.prototype,
                    "_fetchFromMemory", null);
                X([k], b.prototype, "_cacheInMemory", null);
                X([k], b.prototype, "_getContentFragmentConfig", null);
                X([k], b.prototype, "_init", null);
                return b
            }(u),
            ...
            rc = this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
                    g = 3 > c ? b : null === e ? e = Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
                if ("object" === typeof Reflect && "function" === typeof Reflect.decorate) g = Reflect.decorate(f, b, a, e);
            ...
            sc = this && this.__awaiter || function(f,
                b, a, e) {
                function c(b) {
                    return b instanceof a ? b : new a(function(a) {
                        a(b)
                    ...
                    return sc(this,
                        ...
                        function() {
                            return tc(this, function(b) {
                                if (!Ob.isCookieStoreSupported(this._swGlobal)) throw r.create("UnsupportedCookieStoreAPI", {
                                    cookie: a
                                }, void 0, void 0, "WARN");
                    ...
                    return sc(this, void 0, void 0, function() {
                        ...
                        return tc(this, function(c) {
                            switch (c.label) {
                                ...
                                case 1:
                                    return b = c.sent(), [2, b && b.value ? b.value : void 0]
                            }
                        })
                    })
                };
                rc([k], b.prototype, "getCookie", null);
                rc([k], b.prototype,
                    "getCookieValue", null);
                return b
            }(u),
            of = this && this.__extends || function() {
                var f = function(b, a) {
                    f = Object.setPrototypeOf || {
                        __proto__: []
                    }
            ...
            pf = function(f) {
                function b(a) {
                    var b = f.call(this) || this;
                    b._cookieProvider = new nf(a);
                    if (a = R.getCountryCode(a)) b._countryCode = a.toLowerCase();
                    return b
                } of (b, f);
                b.prototype.getSessionId = function() {
                ...
                b.prototype.getRecognition = function() {
                    return Bb(this, void 0, void 0, function() {
                        ...
                        return Cb(this, function(b) {
                            try {
                                if (!this._countryCode) throw r.create("CountryCodeNotFound");
                ...
                b.prototype._getLanguageCookieName = function() {
                    return this._isUSMarketplace() ?
                        "lc-main" : "lc-acb".concat(this._countryCode)
                };
                b.prototype._isUSMarketplace = function() {
                    return this._countryCode === b.US_COUNTRY_CODE
                };
                b.US_COUNTRY_CODE = "us";
                za([k], b.prototype, "getSessionId", null);
                za([k], b.prototype, "getRecognition", null);
                za([k], b.prototype, "getLanguage", null);
                za([k], b.prototype, "_getRecognitionCookieName", null);
                za([k], b.prototype, "_getLanguageCookieName", null);
                return b
            }(u),
            qf = this && this.__extends || function() {
                var f = function(b, a) {
                    f = Object.setPrototypeOf || {
                        __proto__: []
                    }
            ...
            rf = function(f) {
                ...
                b.prototype._getInternalEventName = function(a) {
                    return "".concat(v.NAMESPACE, ":").concat(a)
                };
                qa([k], b.prototype, "publish", null);
                qa([k], b.prototype, "subscribe", null);
                qa([k], b.prototype, "unsubscribe", null);
                qa([k], b.prototype, "_notify", null);
                qa([k], b.prototype, "_getUniqueSubscriptionId", null);
                qa([k], b.prototype, "_getInternalEventName", null);
                return b
            }(u),
            sf = this && this.__extends || function() {
                var f = function(b, a) {
                    f = Object.setPrototypeOf || {
                        __proto__: []
                    }
            ...
            tf = this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
                    g = 3 > c ? b : null === e ? e = Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
                if ("object" === typeof Reflect && "function" === typeof Reflect.decorate) g = Reflect.decorate(f, b, a, e);
            ...
            uf = function(f) {
                ...
                b.prototype._initFetchHandling = function() {
                    ...
                    this.swGlobal.addEventListener("fetch", function(b) {
                        if (a.filter(b)) {
                            var c = ma.create(b.resultingClientId);
                            a.handle(c, b);
                            a.publishEvent(c, b)
                        }
                    })
                };
                tf([k], b.prototype, "_initFetchHandling", null);
                return b
            }(u),
            vf = this && this.__extends || function() {
                var f = function(b, a) {
                    f = Object.setPrototypeOf || {
                        __proto__: []
                    }
            ...
            wf = function(f) {
                ...
                b.prototype.filter = function(a) {
                    ...
                    return "navigate" === a.mode && "document" === b &&
                        "GET" === c && !g
                };
                ...
                b.prototype._hasSkipInterceptUrlParam = function(a, b) {
                    var c = this,
                        e = (b = I.parse(b.request.url)) ? x.skipIntercept.getParam(b) :
                        "NoURL";
                    e && t.queueTask(function() {
                        var b = Ta.onlyWordChars(e).substr(0, 50);
                ...
                Oa([k], b.prototype, "handle", null);
                Oa([k], b.prototype, "publishEvent", null);
                Oa([k], b.prototype, "_hasSkipInterceptUrlParam", null);
                Oa([k], b.prototype, "_requiresButDoesNotSupportNavigationPreload",
                    null);
                return b
            }(uf),
            ...
            N = this && this.__generator || function(f, b) {
                function a(a) {
                    return function(b) {
                        return e([a, b])
                    }
            ...
            yf = function(f) {
                        ...
                        return L(e, void 0, void 0, function() {
                            ...
                            return N(this, function(g) {
                                switch (g.label) {
                                    ...
                                    case 1:
                                        return e = g.sent(), this._postCounter(e, b, c), [3, 3];
                                    case 2:
                ...
                b.prototype.notifyEvent = function(a) {
                    ...
                    switch (a.name) {
                        case "ClientReady":
                            t.queueTask(function() {
                                return L(b, void 0, void 0, function() {
                                    var b, e, h, d = this;
                ...
                b.prototype._bufferCounter = function(a, e, c) {
                    aa.pushClamped(this._bufferedCounters, {
                        clientId: a,
                        name: e,
                        value: c
                    }, b._MAX_COUNTERS)
                ...
                b.prototype._bufferTag = function(a, e) {
                    aa.pushClamped(this._bufferedTags, {
                        clientId: a,
                        name: e
                    }, b._MAX_TAGS)
                };
                b.prototype._bufferError = function(a, e, c, g) {
                    aa.pushClamped(this._bufferedErrors, {
                        clientId: a,
                        message: e,
                        attribution: c,
                        level: g
                ...
                b.prototype._bufferWeblabTrigger = function(a, e, c) {
                    aa.pushClamped(this._bufferedWeblabTriggers, {
                        clientId: a,
                        name: e,
                        treatment: c
            ...
            Af = function(f) {
                function b() {
                    var a = f.call(this) || this;
                    a.logCtor(arguments);
                    a._ready = new wb(b._MAX_CLIENTS);
                    return a
                }
                zf(b, f);
                ...
                b.prototype.markReady = function(a, b) {
                    !this.isReady(a) && q.isNonEmptyString(b) && this._ready.set(a,
                        b)
                };
                b.prototype.getRequestIdForClient = function(a) {
                ...
                b._MAX_CLIENTS = 50;
                Db([k], b.prototype, "isReady", null);
                Db([k], b.prototype, "markReady", null);
                Db([k], b.prototype, "getRequestIdForClient", null);
                return b
            }(u),
            Bf = this && this.__extends || function() {
                var f = function(b, a) {
                    f = Object.setPrototypeOf || {
                        __proto__: []
                    }
            ...
            Eb = this && this.__awaiter || function(f, b, a, e) {
                function c(b) {
                    return b instanceof a ? b : new a(function(a) {
                        a(b)
                    })
            ...
            Fb = this && this.__generator || function(f,
                b) {
                function a(a) {
                    return function(b) {
                        return e([a, b])
            ...
            Cf = function(f) {
                ...
                b.prototype.weblabTrigger = function(a, b, c) {
                    ...
                    this._requestIdReadyStore.isReady(a) ? t.queueTask(function() {
                        return Eb(e, void 0, void 0, function() {
                            var e, d;
                        ...
                        case "RequestIdAvailable":
                            t.queueTask(function() {
                                return Eb(b, void 0, void 0, function() {
                                    var b, e, h, d = this;
                                    return Fb(this, function(c) {
                                        try {
                                            b = a.detail.eventOptions.clientId, e = a.detail.requestId, this._requestIdReadyStore.markReady(b, e), h = this._requestIdReadyStore.getRequestIdForClient(b), t.queueTask(function() {
                                                d._drainBufferedWeblabTriggers(b,
                                                    h)
                                            })
                                        } catch (l) {
                ...
                b._MAX_WEBLAB_TRIGGERS = 100;
                ra([k], b.prototype, "reset", null);
                ra([k], b.prototype, "weblabTrigger", null);
                ra([k], b.prototype, "notifyEvent", null);
                ra([k], b.prototype, "_bufferWeblabTrigger", null);
                ra([k], b.prototype, "_drainBufferedWeblabTriggers", null);
                ra([k], b.prototype, "_postWeblabTrigger", null);
                return b
            }(u),
            ...
            Ef = function(f) {
                function b(a, b, c) {
                    var e = f.call(this) || this;
                    e.logCtor(arguments);
                    e._clientPostbacks = new yf(b, c);
                    e._clientPostbacks.reset();
                    a.$TM && (e._globalTelemetryClient = a.$TM, e._telemetryTriggers = new Cf(e._globalTelemetryClient, c), e._telemetryTriggers.reset());
                    return e
                }
                Df(b, f);
                ...
                b.prototype.weblabTrigger = function(a, b, c, g) {
                    ...
                    void 0 === g && (g = !1);
                    t.queueTask(function() {
                        g && e._telemetryTriggers ? (e._telemetryTriggers.weblabTrigger(a.clientId,
                            b, c), e.count(a, "triggerintent:direct:".concat(b, ":").concat(c))) : (e._clientPostbacks.weblabTrigger(a.clientId, b, c), e.count(a, "triggerintent:ue:".concat(b, ":").concat(c)))
                    })
                };
                b.prototype._getFormattedName = function(a) {
                    return Ca.format(a)
                };
                fa([k], b.prototype, "count", null);
                fa([k], b.prototype, "mark", null);
                fa([k], b.prototype, "tag", null);
                fa([k], b.prototype, "error", null);
                fa([k], b.prototype, "countError", null);
                fa([k], b.prototype, "weblabTrigger", null);
                fa([k], b.prototype, "_getFormattedName", null);
                return b
            }(u),
            Ff = this && this.__extends || function() {
                var f = function(b, a) {
            ...
            Gf = function(f) {
                function b(a, e) {
                    ...
                    c.logCtor(arguments);
                    c._metricsService = e;
                    c._store = new wb(b._MAX_HINT_TARGETS);
                ...
                b.prototype.read = function(a, b) {
                    return Gb(this, void 0, void 0, function() {
                        ...
                        return Hb(this, function(g) {
                            switch (g.label) {
                                case 0:
                                    return g.trys.push([0, 2, , 3]), [4, this._getCustomerContext()];
                                case 1:
                                    return c = g.sent(), [2, this._readFromStore(b, c)];
                                case 2:
                                    return e = g.sent(), C.matchesCode(e, "UnsupportedCookieStoreAPI") || this._metricsService.error(a, r.create("RenderingHintsReadFailed", {
                                        target: b
                                    }, e), this._errorLoggingScope), [2, {}];
                                case 3:
                                    return [2]
                            }
                        })
                ...
                b.prototype.write = function(a, b, c, g) {
                    return Gb(this, void 0, void 0, function() {
                        var e, d, f;
                        return Hb(this, function(h) {
                            switch (h.label) {
                                case 0:
                                    return h.trys.push([0,
                                        2, , 3
                                    ]), [4, this._getCustomerContext()];
                                case 1:
                                    return e = h.sent(), d = Xa.resolveAdsRedirects(b), this._writeToStore(d, c, g, e), [3, 3];
                                case 2:
                                    f = h.sent();
                                    if (C.matchesCode(f, "UnsupportedCookieStoreAPI")) return [2];
                                    this._metricsService.error(a, r.create("RenderingHintsWriteFailed", {
                                        target: b
                                    }, f), this._errorLoggingScope);
                                    return [3, 3];
                                case 3:
                                    return [2]
                            }
                ...
                Pa([k], b.prototype, "write", null);
                Pa([k], b.prototype, "_readFromStore", null);
                Pa([k], b.prototype, "_writeToStore", null);
                Pa([k], b.prototype, "_getCustomerContext", null);
                return b
            }(u),
            Hf = this && this.__extends || function() {
                var f = function(b, a) {
            ...
            Ib = this && this.__assign || function() {
                Ib = Object.assign || function(f) {
                    for (var b, a = 1, e = arguments.length; a < e; a++) {
                        b = arguments[a];
                        for (var c in b) Object.prototype.hasOwnProperty.call(b, c) && (f[c] = b[c])
                    }
            ...
            Jb = this && this.__awaiter || function(f, b, a, e) {
                function c(b) {
                    return b instanceof a ? b : new a(function(a) {
                        a(b)
                    })
            ...
            Kb = this && this.__generator || function(f, b) {
                function a(a) {
                    return function(b) {
                        return e([a, b])
                    }
            ...
            If = function(f) {
                function b(a, b, c) {
                    var e = f.call(this) || this;
                    e.logCtor(arguments);
                    e._navigationContentHintsStore = new Gf(a, b);
                ...
                b.prototype.getHintsDataOnly = function(a, b) {
                    return Jb(this, void 0, void 0, function() {
                        var c, e;
                        return Kb(this, function(g) {
                            switch (g.label) {
                                case 0:
                                    return [4, this.getHints(a, b)];
                                case 1:
                                    return c = g.sent(), e = {}, Object.keys(c).forEach(function(a) {
                                        e[a] = c[a].value
                                    }), [2, e]
                            }
                        })
                ...
                b.prototype._filterValidRenderingHintsEventOptions = function(a) {
                    var b = q.isObject,
                        ...
                        g = q.isOneOf;
                    return a.filter(function(a) {
                        return b(a) && g(a.nature, ["speculated_navigation_content"]) &&
                            c(a.target) && b(a.data) && b(a.source)
                    })
                };
                Qa([k], b.prototype, "getHints", null);
                Qa([k], b.prototype, "getHintsDataOnly", null);
                Qa([k], b.prototype, "notifyEvent", null);
                Qa([k], b.prototype, "_filterValidRenderingHintsEventOptions", null);
                return b
            }(u),
            ...
            Kf = function(f) {
                ...
                b.prototype.logCount = function(a, b) {
                    this._metricsService.count(this._eventOptions,
                        this.getMetricName(a), b)
                };
                ...
                b.prototype.logError = function(a, b) {
                    this._metricsService.error(this._eventOptions, a, this._errorLoggingScope,
                        b)
                };
                ha([k], b.prototype, "getMetricName", null);
                ha([k], b.prototype, "logCount", null);
                ha([k], b.prototype, "logMark", null);
                ha([k], b.prototype, "logTag", null);
                ha([k], b.prototype, "logTagAndCount", null);
                ha([k], b.prototype, "logCountError", null);
                ha([k], b.prototype, "logError", null);
                return b
            }(u),
            ...
            sa = this && this.__awaiter || function(f, b, a, e) {
                function c(b) {
                    return b instanceof a ? b : new a(function(a) {
                        a(b)
                    })
            ...
            ta = this && this.__generator || function(f, b) {
                function a(a) {
                    return function(b) {
                        return e([a,
                            b
            ...
            uc = function(f) {
                ...
                b.prototype.fetchServerResponse = function(a, b) {
                    return sa(this, void 0, void 0, function() {
                        return ta(this, function(c) {
                            return [2, b ? Da.getResponseWithoutRelay(a) : Da.getResponseWithRelay(a)]
                        })
                    })
                };
                        ...
                        return ta(this,
                            function(l) {
                                switch (l.label) {
                                    ...
                                    case 2:
                                        f = l.sent();
                                        if (C.matchesCode(f, "PreloadResponseUnexpected")) {
                                            this._logError(f);
                                            if (!d) throw f;
                                            return [2, this._getReloadBypassFallbackContent(a, b, h, "prx_".concat(g))]
                                        }
                                        if (C.matchesCode(f, "PreloadResponseUnsupported")) {
                                            this._logError(f);
                                            if (!d) throw f;
                                        ...
                                        if (!d) throw k;
                                        return [2,
                                            this._getErrorFallbackContent(a, b, h, "flf_".concat(g))
                                        ];
                                    case 3:
                                        ...
                                        if ("opaqueredirect" === e.type) return [2, h ? {
                                            unrecoverable: !0,
                                            parseable: !1,
                                            response: e
                    ...
                    return sa(this, void 0, void 0, function() {
                        ...
                        return ta(this, function(h) {
                            switch (h.label) {
                                ...
                                case 1:
                                    return e = (d.response = h.sent(), d), [3, 3];
                                case 2:
                                    e = this._getReloadBypassFallbackContent(a, b, c, g), h.label = 3;
                                case 3:
                                    return [2, e]
                            }
                        })
                ...
                b.prototype._getAppErrorFragment = function(a, b) {
                    return sa(this, void 0, void 0, function() {
                        return ta(this, function(c) {
                            ...
                            return [2, (new ce(b, this._metricsService, a.request.url, "-1", "net::ERR_FAILED", a.request.referrer)).getResponse()]
                        })
                    })
                };
                b.prototype._getReloadBypassFragment =
                    function(a, b, c, g) {
                        return sa(this, void 0, void 0, function() {
                            return ta(this, function(e) {
                                this._metricsHelper.logCount("Emit:ReloadFragment");
                                return [2, (new ue(b, this._metricsService, a.request.url, c, !0, "erf_".concat(this._responseRuleName, "_").concat(g))).getResponse()]
                            })
                        })
                    };
                ...
                Y([k], b.prototype, "fetchServerResponse", null);
                Y([k], b.prototype, "readServerResponse", null);
                Y([k], b.prototype, "_getErrorFallbackContent", null);
                Y([k], b.prototype, "_getReloadBypassFallbackContent", null);
                Y([k], b.prototype, "_getAppErrorFragment", null);
                Y([k], b.prototype, "_getReloadBypassFragment", null);
                Y([k], b.prototype,
                    "_logError", null);
                Y([k], b.prototype, "_extractAndPublishRequestId", null);
                return b
            }(u),
            Mf = this && this.__extends || function() {
                var f = function(b, a) {
            ...
            Lb = this && this.__assign || function() {
                Lb = Object.assign || function(f) {
                    for (var b, a = 1, e = arguments.length; a < e; a++) {
                        b = arguments[a];
                        for (var c in b) Object.prototype.hasOwnProperty.call(b, c) && (f[c] = b[c])
                    }
            ...
            vc = this && this.__awaiter || function(f, b, a, e) {
                function c(b) {
                    return b instanceof a ? b : new a(function(a) {
                        a(b)
                    })
            ...
            Nf = function(f) {
                ...
                b.prototype.getHeadersWithPreload = function(a) {
                    return vc(this, void 0, void 0, function() {
                        ...
                        return wc(this, function(e) {
                            switch (e.label) {
                                case 0:
                                    if (!this._preloadConfig.length) return [2, a];
                                    b = [];
                                    c = [];
                                    this._sortConfig(b, c);
                                    return c.length ? [4, this._resolveHints(b,
                                        c)] : [2, this._getOutputHeaders(b, a)];
                                case 1:
                                    return e.sent(), [2, this._getOutputHeaders(b, a)]
                            }
                        })
                    })
                };
                ...
                b.prototype._resolveHints = function(a, b) {
                    return vc(this, void 0, void 0, function() {
                        var c, e = this;
                        return wc(this, function(g) {
                            switch (g.label) {
                                case 0:
                                    return [4, this._renderingHintsService.getHints(this._eventOptions,
                                        this._event.request.url)];
                                case 1:
                                    return c = g.sent(), b.forEach(function(b) {
                                        var d = b.purpose,
                                            g = b.attribution,
                                            f = b.hrefFromHint,
                                            h = b.as;
                                        ...
                                        if (c.hasOwnProperty(f)) {
                                            var k = I.parse(String(c[f].value));
                                            k ? a.push({
                                                purpose: d,
                                                href: k.href,
                                                as: h,
                                                fetchPriority: b,
                                                attribution: e._getAttribution(g, c[f].source)
                                            }) : e._metricsHelper.logCountError(r.create("PreloadHintInvalidURL"))
                                        } else e._metricsHelper.logCount("PreloadHintMissing")
                                    }), [2]
                            }
                        })
                    })
                ...
                b.prototype._getOutputHeaders = function(a, e) {
                    var c = this,
                        ...
                        f = {};
                    a.forEach(function(a) {
                        f[a.href] ? c.log("_getOutputHeaders", "Preload with same URL already issued, ignoring: ".concat(a.href)) : (f[a.href] = !0, g.append(b._PRELOAD_HEADER_NAME, c._getLinkHeaderValue(a)), g.append(b._SERVER_TIMING_HEADER_NAME, c._getServerTimingHeaderValue(a)))
                    });
                    return g
                };
                ...
                b.prototype._getServerTimingHeaderValue =
                    function(a) {
                        a = H.serialize(Lb({
                            role: b._SERVER_TIME_RECORD_ROLE
                        }, a));
                        return "".concat(v.NAMESPACE_LCASE, ';desc\x3d"').concat(J.encodeRFC3986(a), '"')
                    };
                ...
                Z([k], b.prototype, "getHeadersWithPreload", null);
                Z([k], b.prototype, "hasPreload", null);
                Z([k], b.prototype, "_sortConfig",
                    null);
                Z([k], b.prototype, "_resolveHints", null);
                Z([k], b.prototype, "_getOutputHeaders", null);
                Z([k], b.prototype, "_getLinkHeaderValue", null);
                Z([k], b.prototype, "_getServerTimingHeaderValue", null);
                Z([k], b.prototype, "_getAttribution", null);
                return b
            }(u),
            Of = this && this.__extends || function() {
                var f = function(b, a) {
            ...
            Pf = this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
                    g = 3 > c ? b : null === e ? e = Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
                if ("object" === typeof Reflect && "function" === typeof Reflect.decorate) g = Reflect.decorate(f, b, a, e);
            ...
            Qf = this && this.__awaiter || function(f, b, a, e) {
                function c(b) {
                    return b instanceof a ? b : new a(function(a) {
                        a(b)
                    })
            ...
            Rf = this && this.__generator || function(f, b) {
                function a(a) {
                    return function(b) {
                        return e([a, b])
                    }
            ...
            xc = function(f) {
                function b(a, b, c, g, h, d, k, l, p) {
                    ...
                    e.metricsHelper = new Kf(g, l, e.name, p);
                    return e
                }
                Of(b, f);
                b.prototype.getResponse = function() {
                ...
                Pf([k], b.prototype, "getResponse", null);
                return b
            }(u),
            Sf = this && this.__extends || function() {
                var f = function(b, a) {
            ...
            Tf = this && this.__awaiter || function(f, b, a, e) {
                function c(b) {
                    return b instanceof
            ...
            Uf = this && this.__generator || function(f, b) {
                function a(a) {
                    return function(b) {
                        return e([a, b])
                    }
            ...
            Vf = function(f) {
                ...
                b.prototype.getCachedPageFromCache = function(a) {
                    return Tf(this, void 0, void 0, function() {
                        ...
                        return Uf(this, function(e) {
                            switch (e.label) {
                                case 0:
                                    return b = a.cacheName, c = a.cacheKey, g = a.validationKeys, d = (f = this._cacheService).read, k = [this._eventOptions, b, c], l = {}, [4, (new Ia(this._customerContextService)).compute(g)];
                                case 1:
                                    return [2, d.apply(f, k.concat([(l.validationKeys = e.sent(), l)]))]
                            }
                        })
                    })
                };
                ...
                b.prototype.getCachedPageMetadata = function(a) {
                    return (a = (a = (a = a.headers.get(x.shared.getClientOnlyLibHeader("metadata"))) ? J.decode(a) : void 0) ? H.deserialize(a) : void 0) ? {
                        attribution: a.attribution || "unknown",
                        staleness: "number" === typeof a.requestStartTimestampSeconds ? F.getEpochSeconds(this._eventOptions.timeOriginEpoch) - a.requestStartTimestampSeconds : void 0
                    } : {
                        attribution: "unknown"
                    }
                };
                ...
                Aa([k], b.prototype, "getCachedPageFromCache", null);
                Aa([k], b.prototype, "getFilteredCachedPageHeaders", null);
                Aa([k], b.prototype, "getCachedPageMetadata", null);
                Aa([k], b.prototype, "queueCachedPageMetadataMetrics", null);
                Aa([k], b.prototype, "queueCachedPageUpdate", null);
                return b
            }(u),
            ...
            Q = this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
                    g = 3 > c ? b : null === e ? e = Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
                if ("object" === typeof Reflect && "function" === typeof Reflect.decorate) g = Reflect.decorate(f, b, a, e);
            ...
            ia = this && this.__awaiter || function(f, b, a, e) {
                function c(b) {
                    return b instanceof a ? b : new a(function(a) {
                        a(b)
                    })
            ...
            ja = this && this.__generator || function(f, b) {
                function a(a) {
                    return function(b) {
                        return e([a,
                            b
            ...
            Xf = function(f) {
                function b(a, b, c, g, h, d, k, l, p, m, q) {
                    ...
                    e._cachedPageController = new Vf(a, b, e.metricsHelper, d, l, m);
                    e._serverResponseController = new uc(c, e.metricsHelper, d, m);
                    return e
                }
                Wf(b, f);
                b.prototype.build = function() {
                    return ia(this, void 0, void 0, function() {
                        ...
                        return ja(this, function(e) {
                            switch (e.label) {
                                case 0:
                                    a = this._serverResponseController.fetchServerResponse(this._event,
                                        this._usePreloadResponseOnly), this.metricsHelper.logMark("Query:CachedPage"), e.label = 1;
                                case 1:
                                    return e.trys.push([1, 3, , 4]), [4, this._cachedPageController.getCachedPageFromCache(this._cachedPageConfig)];
                                case 2:
                                    return b = e.sent(), [3, 4];
                                case 3:
                                    return c = e.sent(), t.queueTask(function() {
                                        d.metricsHelper.logError(c);
                                        d.metricsHelper.logCountError(c);
                                        d.metricsHelper.logTagAndCount("CachedPageCacheMiss:CacheError")
                                    }), [3, 4];
                                case 4:
                                    return this.metricsHelper.logMark("Arrived:CachedPage"), t.queueTask(function() {
                                        d.metricsHelper.logTagAndCount("CachedPageCache".concat(b ?
                                            "Hit" : "Miss"))
                                    }), b ? (this._cachedPageController.queueCachedPageMetadataMetrics(b), [2, this._getCachedPageAssembledResponse(b, a)]) : [4, this._serverResponseController.readServerResponse(this._event, this.eventOptions, a, "fprs", !0, !0)];
                                case 5:
                                    return g = e.sent(), this.metricsHelper.logMark("Arrived:ServerResponse"), g.parseable && (f = g.response.clone(), this._cachedPageController.queueCachedPageUpdate(f, !1)), [2, g.response]
                            }
                        })
                    })
                };
                b.prototype._getCachedPageAssembledResponse = function(a, b) {
                    return ia(this, void 0, void 0,
                        function() {
                ...
                b.prototype._getAssembledResponseOutputStream = function(a, b) {
                    ...
                    return new ReadableStream({
                        start: function(e) {
                            return ia(c, void 0, void 0, function() {
                                var c, d, g, f, k, m, q, r, t, v, u, w;
                                return ja(this, function(h) {
                                    switch (h.label) {
                                        case 0:
                                            c =
                                                new Ic, this._event.waitUntil(c.promise), h.label = 1;
                                        case 1:
                                            return h.trys.push([1, 13, 14, 15]), d = this._toOutputStream("CachedPage", a, e), g = this._serverResponseController.readServerResponse(this._event, this.eventOptions, b, "fprs", !1, !0), [4, d];
                                        case 2:
                                            return h.sent(), f = this._toOutputStream, k = ["PageMetadata"], [4, this._getPageMetadataFragment(a)];
                                        case 3:
                                            return [4, f.apply(this, k.concat([h.sent(), e]))];
                                        case 4:
                                            h.sent();
                                            if (!M.isDebug) return [3, 7];
                                        ...
                                        case 7:
                                            return [4, g];
                                        case 8:
                                            return r = h.sent(), t = r.unrecoverable, v = r.parseable, u = r.response, this.metricsHelper.logMark("Arrived:ServerResponse"), "opaqueredirect" !== u.type ? [3, 10] : [4, this._toOutputStream("ServerResponse", u, e)];
                                        case 9:
                                            return h.sent(), e.close(), [2];
                                        case 10:
                                            e.close();
                                            this.metricsHelper.logTagAndCount("ServerResponseStatus:".concat(u.status));
                                            if (t || !v) return [3, 12];
                                            this._cachedPageController.queueCachedPageUpdate(u, !0);
                                            return [4, this._drainResponseClone(u)];
                                        case 11:
                                            h.sent(), h.label = 12;
                                        case 12:
                                            return [3, 15];
                                        case 13:
                                            throw w = h.sent(), e.close(), this.metricsHelper.logError(w), this.metricsHelper.logCountError(w), w;
                                        case 14:
                                            return c.resolveWith(), [7];
                                        case 15:
                                            return [2]
                                    }
                                })
                ...
                b.prototype._toOutputStream = function(a,
                    b, c) {
                    return ia(this, void 0, void 0, function() {
                        var e = this;
                        return ja(this, function(g) {
                            switch (g.label) {
                                case 0:
                                    ...
                                    return [4, la.drain(b.body, function(a) {
                                        e._processChunk(a, c)
                                    })];
                                case 1:
                                    return g.sent(), this.metricsHelper.logMark("Flushed:".concat(a)), [2]
                            }
                        })
                    })
                };
                ...
                b.prototype._getPageMetadataFragment = function(a) {
                    return ia(this, void 0, void 0, function() {
                        ...
                        return ja(this, function(e) {
                            b =
                                this._cachedPageController.getCachedPageMetadata(a);
                            c = {
                                attribution: b.attribution,
                                staleness: b.staleness
                            };
                            return [2, (new fc(this.eventOptions, this.metricsService, this.responseRuleName, this.name, c)).getResponse()]
                        })
                    })
                };
                b.prototype._getDebugInfoFragment = function() {
                    return ia(this, void 0, void 0, function() {
                        return ja(this, function(a) {
                            return [2, (new cc(this.eventOptions, this.metricsService, this._event.request.url)).getResponse()]
                        })
                    })
                };
                Q([k], b.prototype, "build", null);
                Q([k], b.prototype, "_getCachedPageAssembledResponse",
                    null);
                Q([k], b.prototype, "_getAssembledResponseInit", null);
                Q([k], b.prototype, "_getAssembledResponseOutputStream", null);
                Q([k], b.prototype, "_drainResponseClone", null);
                Q([k], b.prototype, "_toOutputStream", null);
                Q([k], b.prototype, "_processChunk", null);
                Q([k], b.prototype, "_getPageMetadataFragment", null);
                Q([k], b.prototype, "_getDebugInfoFragment", null);
                return b
            }(xc),
            ...
            Zf = this && this.__awaiter || function(f, b, a, e) {
                function c(b) {
                    return b instanceof a ? b : new a(function(a) {
                        a(b)
                    })
            ...
            ag = function(f) {
                    ...
                    return Zf(this, void 0, void 0, function() {
                        ...
                        return $f(this, function(e) {
                            switch (e.label) {
                                case 0:
                                    return b =
                                        a.cacheName, c = a.cacheKey, g = a.validationKeys, f = a.delimiterKey, d = a.skeleton, p = (l = this._cacheService).read, m = [this._eventOptions, b, c], u = {}, [4, (new Ia(this._customerContextService)).compute(g)];
                                case 1:
                                    return [4, p.apply(l, m.concat([(u.validationKeys = e.sent(), u)]))];
                                case 2:
                                    k = e.sent();
                                    if (!k) return [2];
                                    r = (q = k.headers.get(x.shared.getClientOnlyLibHeader(f))) ? J.decode(q) : void 0;
                                    return r ? [2, {
                                        delimiter: r,
                                        response: k,
                                        skeleton: d
                ...
                b.prototype.queuePageShellMetadataMetrics =
                    function(a) {
                        var b = this;
                        t.queueTask(function() {
                ...
                Ba([k], b.prototype, "getPageShellFromCache", null);
                Ba([k], b.prototype, "getFilteredPageShellHeaders", null);
                Ba([k], b.prototype, "getPageShellMetadata", null);
                Ba([k], b.prototype, "queuePageShellMetadataMetrics", null);
                Ba([k], b.prototype, "queuePageShellUpdate", null);
                return b
            }(u),
            bg = this && this.__extends || function() {
                var f = function(b, a) {
                    f = Object.setPrototypeOf || {
                        __proto__: []
                    }
            ...
            B = this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
                    g = 3 > c ? b : null === e ? e = Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
                if ("object" === typeof Reflect && "function" === typeof Reflect.decorate) g = Reflect.decorate(f,
            ...
            z = this && this.__generator || function(f,
                b) {
                function a(a) {
                    return function(b) {
                        return e([a, b])
            ...
            cg = function(f) {
                function b(a, b, c, g, h, d, k, l, p, m, q, r, t, u) {
                    ...
                    e._flags = u || {};
                    e._pageShellController = new ag(a, b, e.metricsHelper, d, l, m);
                    e._serverResponseController = new uc(c, e.metricsHelper, d, m);
                    e._preloadController = new Nf(h, e.metricsHelper, k, l, t);
                    return e
                }
                bg(b, f);
                b.prototype.build = function() {
                        ...
                        function() {
                            ...
                            return z(this, function(e) {
                                switch (e.label) {
                                    ...
                                    case 1:
                                        if (b = e.sent()) return [2, this._getPageShellAssembledResponse(b, a)];
                                        if (this._noPageShellConfig.skeleton || this._preloadController.hasPreload()) return [2,
                                            this._getNoPageShellAssembledResponse(this._noPageShellConfig, a)
                                        ];
                                        e.label = 2;
                                    case 2:
                            ...
                            switch (d.label) {
                                ...
                                case 4:
                                    return g = d.sent(), t.queueTask(function() {
                                        var a = C.matchesCode(g, "NetworkError");
                        ...
                        return z(this, function(d) {
                            switch (d.label) {
                                ...
                                case 1:
                                    ...
                                    }), b.parseable && (g = b.response.clone(), c.push(function() {
                                        return y(f, void 0, void 0, function() {
                                            return z(this, function(a) {
                ...
                b.prototype._getPageShellAssembledResponse =
                    function(a, b) {
                        return y(this, void 0, void 0, function() {
                            var c, e;
                            return z(this, function(g) {
                                switch (g.label) {
                                    case 0:
                                        return c = this._getPageShellAssembledResponseOutputStream(a, b), [4, this._getPageShellAssembledResponseInit(a)];
                                    case 1:
                                        return e = g.sent(), [2, new Response(c, e)]
                                }
                            })
                        })
                    };
                b.prototype._getNoPageShellAssembledResponse = function(a, b) {
                    return y(this, void 0, void 0, function() {
                        ...
                        return z(this, function(g) {
                            switch (g.label) {
                                case 0:
                                    return c = this._getNoPageShellAssembledResponseOutputStream(a, b), [4, this._getNoPageShellAssembledResponseInit()];
                                case 1:
                                    return e = g.sent(), [2, new Response(c, e)]
                            }
                        })
                ...
                b.prototype._getNoPageShellAssembledResponseInit = function() {
                    return y(this, void 0, void 0, function() {
                        ...
                        return z(this, function(b) {
                            switch (b.label) {
                                case 0:
                                    return [4, this._preloadController.getHeadersWithPreload(ua.getCommonHTMLHeaders())];
                                case 1:
                                    return a = b.sent(), [2, {
                                        status: 200,
                                        statusText: "OK",
                    ...
                    return new ReadableStream({
                        start: function(e) {
                            return y(c, void 0, void 0, function() {
                                var c, d, g, f, k, m, q, r, t, u, v, w, x, y, A, B, F, D, G, H, I, J, K, E, L;
                                return z(this, function(h) {
                                    switch (h.label) {
                                        case 0:
                                            return h.trys.push([0, 24, , 25]),
                                                c = this._toOutputStream("PageShell", a.response, e), d = this._serverResponseController.readServerResponse(this._event, this.eventOptions, b, "sdrs", !1, !0), g = this._getSkeletonFragment(a, d), [4, c];
                                        case 1:
                                            return h.sent(), [4, g];
                                        case 2:
                                            return (f = h.sent()) ? [4, this._toOutputStream("Skeleton", f, e)] : [3, 4];
                                        case 3:
                                            h.sent(), h.label = 4;
                                        case 4:
                                            return k = this._toOutputStream, m = ["ShellRenderPerfCounter"], [4, this._getPerfCounterFragment(this.metricsHelper.getMetricName("ShellRender"))];
                                        case 5:
                                            return [4, k.apply(this, m.concat([h.sent(),
                                                e
                                            ]))];
                                        case 6:
                                            return h.sent(), [4, d];
                                        case 7:
                                            return q = h.sent(), r = q.unrecoverable, t = q.parseable, u = q.response, this.metricsHelper.logMark("Arrived:ServerResponse"), r ? [4, this._toOutputStream("ServerResponse", u, e)] : [3, 9];
                                        case 8:
                                            return h.sent(), e.close(), [2];
                                        case 9:
                                            return v = this._getCSMTokensFragment(a.response, u), w = this._getPageMetadataFragment(a.response, u), x = t ? this._getAfterDelimiterFragment(a, u) : Promise.resolve(u.clone()), y = this._toOutputStream, A = ["CSMTokens"], [4, v];
                                        case 10:
                                            return [4, y.apply(this, A.concat([h.sent(),
                                                e
                                            ]))];
                                        case 11:
                                            return h.sent(), B = this._toOutputStream, F = ["PageMetadata"], [4, w];
                                        case 12:
                                            return [4, B.apply(this, F.concat([h.sent(), e]))];
                                        case 13:
                                            h.sent(), D = !1, h.label = 14;
                                        case 14:
                                            return h.trys.push([14, 17, , 20]), G = this._toOutputStream, H = ["AfterDelimiter"], [4, x];
                                        case 15:
                                            return [4, G.apply(this, H.concat([h.sent(), e]))];
                                        case 16:
                                            return h.sent(), [3, 20];
                                        case 17:
                                            I = h.sent();
                                            if (!C.matchesCode(I, "StreamTransformMissingDelimiter")) return [3, 19];
                                            D = !0;
                                            this.metricsHelper.logTagAndCount("MissingDelimiter");
                                            return this._flags.flushFullOnMissingDelimiter ? [4, this._toOutputStream("MissingDelimiterFallback", u.clone(), e)] : [3, 19];
                                        case 18:
                                            h.sent(), h.label = 19;
                                        case 19:
                                            return [3, 20];
                                        case 20:
                                            if (!M.isDebug) return [3, 23];
                                            J = this._toOutputStream;
                                            K = ["DebugInfo"];
                                            return [4, this._getDebugInfoFragment()];
                                        case 21:
                                            return [4, J.apply(this, K.concat([h.sent(), e]))];
                                        case 22:
                                            h.sent(), h.label = 23;
                                        case 23:
                                            e.close();
                                            this.metricsHelper.logTagAndCount("ServerResponseStatus:".concat(u.status));
                                            if (!t || D) return [2];
                                            this._pageShellController.queuePageShellUpdate(u, !0);
                                            return [3, 25];
                                        case 24:
                                            throw E =
                                                h.sent(), e.close(), L = C.matchesCode(E, "NetworkError"), this.metricsHelper.logError(E, L ? "ERROR" : void 0), this.metricsHelper.logCountError(E), E;
                                        case 25:
                                            return [2]
                                    }
                                })
                ...
                b.prototype._getNoPageShellAssembledResponseOutputStream = function(a, b) {
                    ...
                    return new ReadableStream({
                        start: function(e) {
                            return y(c, void 0, void 0, function() {
                                var c, d, g, f, k, m, q, r, u, t, v;
                                return z(this, function(h) {
                                    switch (h.label) {
                                        case 0:
                                            return h.trys.push([0, 9, , 10]), c = this._serverResponseController.readServerResponse(this._event, this.eventOptions,
                                                b, "sdrsn", !1, !0), d = this._getSkeletonFragment(a, c), [4, d];
                                        case 1:
                                        ...
                                        case 3:
                                            return [4, c];
                                        case 4:
                                            return f = h.sent(), k = f.unrecoverable, m = f.parseable, q = f.response, this.metricsHelper.logMark("Arrived:ServerResponse"), [4, this._toOutputStream("ServerResponse", q.clone(), e)];
                                        case 5:
                                            h.sent();
                                            if (k) return e.close(), [2];
                                            if (!M.isDebug) return [3, 8];
                                            r = this._toOutputStream;
                                            u = ["DebugInfo"];
                                            return [4, this._getDebugInfoFragment()];
                                        case 6:
                                            return [4,
                                                r.apply(this, u.concat([h.sent(), e]))
                                            ];
                                        case 7:
                                            h.sent(), h.label = 8;
                                        case 8:
                                            ...
                                            return [3, 10];
                                        case 9:
                                            throw t = h.sent(), e.close(), v = C.matchesCode(t, "NetworkError"), this.metricsHelper.logError(t, v ? "ERROR" : void 0), this.metricsHelper.logCountError(t), t;
                                        case 10:
                                            return [2]
                                    }
                                })
                    ...
                    return y(this, void 0, void 0, function() {
                        ...
                        return z(this, function(g) {
                            switch (g.label) {
                                ...
                                case 1:
                                    return f.hints = g.sent(), d = c.hooks, k = this.contentFragmentService.render(this.eventOptions, c.name, {
                                        data: e,
                                        hooks: d
                                ...
                                case 4:
                                    p = g.sent(), g.label = 5;
                                case 5:
                                    return l = p, m = l instanceof Response, this.metricsHelper.logMark("Arrived:Skeleton"), this.metricsHelper.logTag("Skeleton:Race:".concat(!!c.race)), this.metricsHelper.logTag("Skeleton:Render:".concat(m)), [2, m ? l : void 0]
                            }
                        })
                    })
                };
                b.prototype._getCSMTokensFragment = function(a, b) {
                    return y(this, void 0, void 0, function() {
                        ...
                        return z(this, function(e) {
                            ...
                            return [2, (new he(this.eventOptions, this.metricsService, b, c.attribution)).getResponse()]
                        })
                    })
                };
                b.prototype._getPageMetadataFragment = function(a, b) {
                    return y(this, void 0, void 0, function() {
                        ...
                        return z(this, function(g) {
                            ...
                            return [2, (new fc(this.eventOptions, this.metricsService, this.responseRuleName, this.name, p)).getResponse()]
                        })
                    })
                };
                b.prototype._getPerfCounterFragment = function(a) {
                    return y(this, void 0, void 0, function() {
                        return z(this, function(b) {
                            return [2, (new qe(this.eventOptions, this.metricsService, a)).getResponse()]
                        })
                    })
                };
                b.prototype._getAfterDelimiterFragment =
                    function(a, b) {
                        return y(this, void 0, void 0, function() {
                            return z(this, function(c) {
                                return [2, (new Wd(this.eventOptions, this.metricsService, b, a.delimiter)).getResponse()]
                            })
                        })
                    };
                b.prototype._getDebugInfoFragment = function() {
                ...
                B([k], b.prototype, "build", null);
                B([k], b.prototype, "_getPageShellAssembledResponse", null);
                B([k], b.prototype, "_getNoPageShellAssembledResponse",
                    null);
                B([k], b.prototype, "_getPageShellAssembledResponseInit", null);
                B([k], b.prototype, "_getNoPageShellAssembledResponseInit", null);
                B([k], b.prototype, "_getPageShellAssembledResponseOutputStream", null);
                B([k], b.prototype, "_getNoPageShellAssembledResponseOutputStream", null);
                B([k], b.prototype, "_toOutputStream", null);
                B([k], b.prototype, "_processChunk", null);
                B([k], b.prototype, "_getSkeletonFragment", null);
                B([k], b.prototype, "_getCSMTokensFragment", null);
                B([k], b.prototype, "_getPageMetadataFragment", null);
                B([k],
                    b.prototype, "_getPerfCounterFragment", null);
                B([k], b.prototype, "_getAfterDelimiterFragment", null);
                B([k], b.prototype, "_getDebugInfoFragment", null);
                return b
            }(xc),
            dg = this && this.__extends || function() {
                var f = function(b, a) {
                    f = Object.setPrototypeOf || {
                        __proto__: []
                    }
            ...
            fg = this && this.__extends || function() {
                var f = function(b, a) {
                    f = Object.setPrototypeOf || {
                        __proto__: []
                    }
            ...
            O = this && this.__decorate || function(f, b, a, e) {
                var c = arguments.length,
                    g = 3 > c ? b : null === e ? e = Object.getOwnPropertyDescriptor(b, a) : e,
                    h;
                if ("object" === typeof Reflect &&
            ...
            gg = function(f) {
                function b(a, b, c, g, h, d, k, l) {
                    var e = f.call(this, a, b, c, g, h, d) || this;
                    e.logCtor(arguments);
                    e._usePreloadResponseOnlyForServerResponseOnNavigations = l.usePreloadResponseOnlyForServerResponseOnNavigations;
                    e._errorLoggingScope = "NavigationResponseService";
                    e._initNavigationRules(k);
                        ...
                        switch (b.strategy.name) {
                            case "SingleDelimiter":
                                b.strategy.pageShells.forEach(function(b) {
                                    b.skeleton &&
                                        a._publishSpeculatedContentFragmentUsage(b.skeleton)
                ...
                b.prototype._createRouteMatcher = function(a) {
                    switch (a.name) {
                        case "URLPathRoute":
                            return new Xb(a.pattern, a.stripRefMarkers, a.stripLanguageFolder);
                        default:
                ...
                b.prototype._createResponseStrategy = function(a, b, c, f) {
                    switch (b.name) {
                        case "SingleDelimiter":
                            return new cg(this.customerContextService, this.cacheService, this.metricsService, this.contentFragmentService, this.renderingHintsService, this.eventBus, f, c, this._usePreloadResponseOnlyForServerResponseOnNavigations,
                                a, b.pageShells, b.noPageShell, b.preloads, b.flags);
                        case "FullPage":
                            return new Xf(this.customerContextService, this.cacheService, this.metricsService, this.contentFragmentService, this.renderingHintsService, this.eventBus, f, c, this._usePreloadResponseOnlyForServerResponseOnNavigations, a, b.cachedPage);
                        default:
                ...
                b.prototype._logTag = function(a, b, c) {
                    ...
                    t.queueTask(function() {
                        ...
                        e.metricsService.tag(a, "Respond:".concat(f, ":").concat(c))
                    })
                };
                ...
                O([k], b.prototype, "respond", null);
                O([k], b.prototype, "_initNavigationRules", null);
                O([k], b.prototype, "_speculateContentFragmentUsage",
                    null);
                O([k], b.prototype, "_publishSpeculatedContentFragmentUsage", null);
                O([k], b.prototype, "_doesRuleMatch", null);
                O([k], b.prototype, "_createRouteMatcher", null);
                O([k], b.prototype, "_createResponseStrategy", null);
                O([k], b.prototype, "_triggerWeblabs", null);
                O([k], b.prototype, "_logTag", null);
                O([k], b.prototype, "_logMark", null);
                return b
            }(eg),
            hg = this && this.__extends || function() {
                var f = function(b, a) {
                    f = Object.setPrototypeOf || {
                        __proto__: []
                    }
            ...
            Ra = this && this.__assign || function() {
                Ra = Object.assign || function(f) {
                    for (var b, a = 1, e = arguments.length; a < e; a++) {
                        b = arguments[a];
                        for (var c in b) Object.prototype.hasOwnProperty.call(b, c) && (f[c] = b[c])
                    }
            ...
            ig = function(f) {
                function b(a) {
                    ...
                    var c = b._getGlobal(a),
                        g = b._getFlags(a);
                    if (!b._isSupported(c, g) || !b._isClientEnabled(c)) return b;
                ...
                b.prototype._checkAlreadyStarted = function() {
                    if (yc) throw r.create("DuplicateLibraryInitialization");
                    yc = !0
                };
                b.prototype._logDebugInfo = function(a) {
                    M.isDebugVerbose && this.log("_logDebugInfo", "Lib Init", {
                        startTimeSeconds: F.getEpochSeconds(),
                        libInfo: v,
                        options: a
                    })
                };
                ...
                b.prototype._getFlags = function(a) {
                    var b = {
                        usePreloadResponseOnlyForServerResponseOnNavigations: R.isMShop()
                    };
                    return Ra(Ra({}, b), a.flags)
                };
                b.prototype._getConfig = function(a) {
                    ...
                    return {
                        caches: (new bf).filter(a.caches),
                        cachePopulationRules: (new gf).filter(a.cachePopulationRules),
                        navigationResponseRules: (new jf).filter(a.navigationResponseRules),
                        contentFragments: (new ef).filter(a.contentFragments)
                    }
                };
                ...
                b.prototype._isClientEnabled = function(a) {
                    a = R.isClientEnabled(a);
                    if (void 0 === a) throw r.create("RuntimeConfigMissing");
                    return a
                };
                b.prototype._startServices = function(a, b, c) {
                    var e = new rf,
                        ...
                        d = new pf(a);
                    f = new Ef(a, f, e);
                    var k = new fd(a, f, c.caches),
                        l = new lf(f, e, c.contentFragments),
                        p = new If(d, f, e);
                    l = new gg(d, k, f, l, p, e, c.navigationResponseRules, b);
                    new Je(a, d, k, f, e, c.cachePopulationRules);
                    new wf(a, l, f, e, b)
                };
                return b
            }(u);
        ...
        return {
            contentFragments: (this && this.__spreadArray || function(d, b, e) {
                if (e || 2 === arguments.length)
                    for (var a = 0, f = b.length, c; a < f; a++) !c && a in b || (c || (c = Array.prototype.slice.call(b, 0, a)), c[a] = b[a]);
...
(function() {})();
var WPN_CL_PNAFV = "AmazonWebPushNotificationsClientLib-1.0.6522.0",
    AUI_JS_DEBUG = !1;
(function(a) {
    a.init = function(a) {}
